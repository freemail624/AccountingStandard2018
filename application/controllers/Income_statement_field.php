...
class Income_statement_field extends CORE_Controller
{
    ...
    public function index() {
        ...
        $data['title'] = 'Income Statement - Department Costing';
    ...
    function transaction($txn)
    {
        switch($txn)
        {
            case 'export-excel':
                ...
                $department_name=$this->Departments_model->get_list($depid)[0]->department_name;
                if($depid==1){$depid=null;}
                $income_accounts = $m_journal->get_account_balance_per_line(4,$depid,date("Y-m-d",strtotime($start)),date("Y-m-d",strtotime($end)));
                ...
                header('Content-Disposition: attachment;filename="Income Statement - Department Costing'.date('Y-m-d',strtotime($end)).'.xlsx"');
        ...
        case 'email-excel':
                ...
                $data = ob_get_clean();
                          ...
                          $file_name='Income Statement Department Costing'.date('Y-m-d h:i:A', now());
                            ...
                            $subject = 'Income Statement (Department Costing)';
                          //  $message = 'Type your gmail message here';
                            ...
                            $response['stat']='error';
                            $response['msg']='Please check the Email Credentials or your Internet Connection.';
