		...
		function transaction($txn=null){
			switch ($txn) {
				...
				case 'export':
	                ...
	                header('Content-Disposition: attachment;filename='."REPLENISHMENT BATCH REPORT.xlsx".'');
				...
				case 'email':
	                ...
	                $data = ob_get_clean();
                            ...
                            $file_name='Replenishment Batch Report '.date('Y-m-d h:i:A', now());
                            ...
                            $subject = 'Replenishment Batch Report';
