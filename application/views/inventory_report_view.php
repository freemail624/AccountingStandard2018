...
<script>
    $(document).ready(function(){
        var dt; var _cboDepartment; var _cboCategories; 
        ...
        var bindEventControls=function(){
            ...
            $(document).on('click','#btn_print',function(){
                window.open('Inventory/transaction/preview-inventory?depid='+$('#cbo_department').val()+'&date='+$('#txt_date').val()+'&catid='+$('#cbo_categories').val()+'&supid='+$('#cbo_supplier').val());
            });

            $(document).on('click','#btn_print_detailed',function(){
                window.open('Inventory/transaction/preview-inventory-with-total?depid='+$('#cbo_department').val()+'&date='+$('#txt_date').val()+'&catid='+$('#cbo_categories').val()+'&supid='+$('#cbo_supplier').val());
            });


            $(document).on('click','#btn_export',function(){
                window.open('Inventory/transaction/export-inventory?depid='+$('#cbo_department').val()+'&date='+$('#txt_date').val()+'&catid='+$('#cbo_categories').val()+'&supid='+$('#cbo_supplier').val());
            });

            $(document).on('click','#btn_export_detailed',function(){
                window.open('Inventory/transaction/export-inventory-with-total?depid='+$('#cbo_department').val()+'&date='+$('#txt_date').val()+'&catid='+$('#cbo_categories').val()+'&supid='+$('#cbo_supplier').val());
            });
            ...
            $(document).on('click','#btn_email',function(){
                ...
                $.ajax({
                    "dataType":"json",
                    "type":"POST",
                    "url":'Inventory/transaction/email-inventory?depid='+$('#cbo_department').val()+'&date='+$('#txt_date').val()+'&catid='+$('#cbo_categories').val()+'&supid='+$('#cbo_supplier').val(),
