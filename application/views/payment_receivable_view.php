                                    ...
                                    <div id="div_payment_list">
                                        ...
                                        <div class="panel panel-default">
                                            ...
                                            <div class="panel-body table-responsive" style="overflow-x: hidden;">
                                                <h2 class="h2-panel-heading">Collection Entry<small> | <a href="assets/manual/sales/Collection_Entry.pdf" target="_blank" style="color:#999999;"><i class="fa fa-question-circle"></i></a></small></h2>
                                                <hr>
                                                <div class="row">
                                    ...
                                    <div id="div_payment_fields" style="display: none;">
                                        <div class="panel panel-default">
                                            <div class="panel-body">
                                                <h2 class="h2-panel-heading">Collection Entry</h2>
                                                <hr>
                                                                    ...
                                                                    <div class="col-lg-6">
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-lg-12">
                                                                                ...
                                                                                <select id="cbo_branch" name="department" required data-error-msg="Parent is required" data-default="<?php echo $accounts[0]->default_department_id; ?>">
                                                            ...
                                                            <div class="row-panel">
                                                                <div class="row">
                                                                    <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                                                                        <label class="control-label"><strong>Please select Branch first <b class="required">*</b> :</strong></label>
                                                                        <select name="customer_id" id="cbo_Customers" data-error-msg="Branch is required." required>
                                                        ...
                                                        $(document).ready(function() {
                                                            ...
                                                            var initializeControls = function() {
                                                                dt = $('#tbl_payments').DataTable({
                                                                    ...
                                                                    processing: true,
                                                                    "ajax": {
                                                                        "url": "Receivable_payments/transaction/list",
                                                                        "bDestroy": true,
                                                                        "data": function(d) {
                                                                            return $.extend({}, d, {
                                                                ...
                                                                _cboCustomers = $("#cbo_Customers").select2({
                                                                    placeholder: "Please select Branch to record payment.",
                                                                    allowClear: true
                                                                });
                                                            ...
                                                            var postPayment = function() {
                                                                ...
                                                                _data.push({
                                                                    ...
                                                                    value: getFloat($('#td_total_payment').text())
                                                                });
                                                                _data.push({
                                                                    name: "remarks",
