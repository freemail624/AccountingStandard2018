                ...
                <div class="static-content">
                    <div class="page-content">
                        ...
                        <ol class="breadcrumb" style="margin:0;">
                            ...
                            <li><a href="RefCustomerType">Branch Type</a></li>
                        </ol>
                                        ...
                                        <div id="div_unit_list">
                                            <div class="panel panel-default" style="border-top: 3px solid #2196f3;">
                                                <div class="panel-body table-responsive">
                                                    <h2 style="margin-top: 0;">Branch Type</h2>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-body">
                                <form id="frm_customer_type" role="form" class="form-horizontal row-border">
                                    <div class="form-group">
                                        <label class="col-md-3 col-md-offset-1 control-label"><strong>* Branch Type :</strong></label>
                                        <div class="col-md-7">
                                            <div class="input-group">
                                                <span class="input-group-addon">
                                                    <i class="fa fa-cube"></i>
                                                </span>
                                                <input type="text" name="customer_type" class="form-control" placeholder="Branch Type" data-error-msg="Branch Type is required!" required>
                                            </div>
                                        </div>
                                    </div>
        ...
        $(document).ready(function() {
            ...
            var initializeControls = function() {
                ...
                var createToolBarButton = function() {
                    var _btnNew = '<button class="btn btn-green"  id="btn_new" style="text-transform: capitalize;font-family: Tahoma, Georgia, Serif;" data-toggle="modal" data-target="" data-placement="left" title="New unit" >' +
                        '<i class="fa fa-cube"></i> New Branch Type</button>';
            ...
            var bindEventHandlers = (function() {
                ...
                $('#btn_new').click(function() {
                    _txnMode = "new";
                    $('#custtype_title').text('New Branch Type');
                ...
                $('#tbl_customer_type tbody').on('click', 'button[name="edit_info"]', function() {
                    ...
                    $('#custtype_title').text('Edit Branch Type');
                    $('#modal_customer_type').modal('show');
                    //showList(false);
                });
            ...
            var removeCustomertype = function() {
                return $.ajax({
                    ...
                    "data": {
                        refcustomertype_id: _selectedID
                    }
                });
            };
