...
<div data-widget-group=" group1">
            ...
            <b style="color: white; font-size: 12pt;"><i class="fa fa-bars"></i>&nbsp; Issuance</b>
                                            ...
                                            <div class="panel-body table-responsive">
                                                <h2 class="h2-panel-heading">Issuance</h2>
                                                <hr>
...
<div id=" modal_sales_order" class="modal fade" role="dialog">
                                                        ...
                                                        <div class="modal-dialog modal-lg">
                                                            <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                    <table id="tbl_si_list" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                                                        <thead class="">
                                                                            <tr>
                                                                                <th></th>
                                                                                <th>Invoice #</th>
                                                    ...
                                                    <!---modal-->
                                                    <div id="modal_create_customer" class="modal fade" tabindex="-1" role="dialog">
                                                        <!--modal-->
                                                        <div class="modal-dialog modal-lg">
                                                            <div class="modal-content">
                                                                                ...
                                                                                <div class="col-md-12">
                                                                                    <div class="col-md-4" id="label">
                                                                                        <label class="control-label boldlabel" style="text-align:right;">
                                                                                            <font color="red"><b>*</b></font> Branch Name :
                                                                                        </label>
                                                                                    </div>
                                                                                    <div class="form-group">
                                                                                        <div class="input-group">
