...
<html>
<head>
    <title>Special Journal - CARF</title>
    <style type="text/css">
        body {
...
<?php 
$trans = '';
if($journal_info->carf_trans_id == 1){
    $trans = 'Vale';
}else if ($journal_info->carf_trans_id == 2){
    $trans = 'Subject For Liquidation (SFL)';
}else if($journal_info->carf_trans_id == 3){
    $trans = 'Borrowings';
}
...
?>
    ...
    <div class="">
        <h3 class="report-header"><strong>SPECIAL JOURNAL - CARF</strong></h3>
    </div>
    <table width="100%" border="0" cellspacing="-1">
        ...
        <tr>
            <td style="padding: 4px;"><strong>TRANSACTION :</strong> <?php echo $trans ?></td>
