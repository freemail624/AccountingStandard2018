                ...
                <td style="border: 0px !important;" class="supplier_tab">
                    <div class="tab-container tab-top tab-default" style="height: auto;border-left: 0px!important;">
                        <ul class="nav nav-tabs">
                            ...
                            <li><a href="#invoice_info<?php echo $customer_info->customer_id; ?>" data-toggle="tab" class="tab-label"><i class="fa fa-users"></i> Branch Invoice</a></li>
                            ...
                            <div class="tab-pane active" id="customer_info<?php echo $customer_info->customer_id; ?>" style="min-height: 300px;">
                                <div class="row">
                                    ...
                                    <div class="col-lg-5"><br />
                                        <center>
                                            <img class="img-circle" src="<?php echo $customer_info->photo_path; ?>" style="border: 2px solid #000000" height="150" width="150" />
                                        </center>
