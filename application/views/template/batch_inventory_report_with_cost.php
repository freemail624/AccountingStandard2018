...
<div style="">
    <table width="100%" border="0">
        <tr>
            <td width="5%"><img src="<?php echo base_url().$company_info->logo_path; ?>" style="height: 90px; width: 200px;"></td>
            <td width="95%" class="" align="left">
                <span style="font-size: 20px;" ><strong><?php echo $company_info->company_name; ?></strong></span><br>
    ...
    <h3 style="margin-bottom: 0px;">Admin Inventory Report - <?php echo $department; ?>
        </h3>
    ...
    <table width="100%" >
        <thead>
            <tr>
                <td valign="top" width="5%">PLU</td>
                <td valign="top" width="30%">Description</td>
                <td valign="top" width="20%">Category</td>
                <td valign="top" width="5%">Unit</td>
                <td valign="top" width="5%" align="right">In</td>
                <td valign="top" width="5%" align="right">Out</td>
                <td valign="top" width="10%" align="right">Balance</td>
                <td valign="top" width="10%" align="right">Cost Price</td>
