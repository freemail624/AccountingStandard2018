...
<div class="row" >
    <div class="col-lg-12">
        <div class="title-action" style="margin-left: 3%;">
            <button name="mark_as_checked" type="button" class="btn btn-primary" style="text-transform: none;"><i class="fa fa-check-circle"></i> <span class=""></span> Mark this as Checked </button>
