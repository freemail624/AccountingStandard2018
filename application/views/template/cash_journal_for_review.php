                                                ...
                                                <div class="row">
                                                    <div class="col-lg-7">
                                                        ...
                                                        <select name="customer_id" class="cbo_customer_list">
                                                            <option value="<?php echo $info->customer_id; ?>"><?php echo $info->customer_no . ' - ' . $info->customer_name; ?></option>
                                                        </select>
                                                    </div>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td class="align-right"><?php echo number_format($item->cost_upon_invoice, 2); ?></td>
