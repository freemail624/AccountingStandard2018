...
<ul class="nav nav-tabs">
    <li class="active"><a href="#journal_review_<?php echo $info->prime_hotel_integration_id; ?>" data-toggle="tab"><i class="fa fa-gavel"></i> Review Journal</a></li>
    <!-- <li class=""><a href="#item_review_<?php echo $info->prime_hotel_integration_id; ?>" data-toggle="tab"><i class="fa fa-folder-open-o"></i> Transaction</a></li> -->
</ul>
<div class="tab-content">
<div class="tab-pane active" id="journal_review_<?php echo $info->prime_hotel_integration_id; ?>" data-parent-id="<?php echo $info->prime_hotel_integration_id; ?>" style="min-height: 300px;">
    <?php if(!$valid_particular){ ?>
        <div class="alert alert-dismissable alert-danger">
            <i class="ti ti-close"></i>&nbsp; <strong>Sorry!</strong> We could not find the record of the customer specified.</b>.<br />
            <i class="ti ti-close"></i>&nbsp; Please make sure that the customer is not deleted or cancelled to your masterfile record.
            <br /><br />
    ...
    <span ><input type="hidden" name="ref_no" value="" placeholder="ref_no"></span>
        ...
        <hr />
        <div style="width: 90%;">
            <input type="hidden" name="prime_hotel_integration_id" value="<?php echo $info->prime_hotel_integration_id; ?>">
        ...
        <hr />
        <table id="tbl_entries_for_review_<?php echo $info->prime_hotel_integration_id; ?>" class="table table-striped" style="width: 100% !important;">
            <thead>
        ...
        <div class="col-lg-12">
            <textarea name="remarks" class="form-control" style="width: 100%;height: 100px;"><?php  echo $info_remarks;?></textarea>
        </div>
        <br /><hr />
    </form>
    <br /><br /><hr />
    <div class="row">
        <div class="col-lg-12">
            <button name="btn_finalize_journal_review" type="button" class="btn btn-primary  <?php if(!$valid_particular){ echo "disabled"; }?>"><i class="fa fa-check-circle"></i> <span class=""></span> Finalize this Journal</button>
        </div>
    </div>
</div>
<div class="tab-pane" id="item_review_<?php echo $info->prime_hotel_integration_id; ?>" >
