...
<div>
    ...
    <center>
        <table width="100%" style="border-collapse: collapse;border-spacing: 0;font-family: tahoma;font-size: 11">
            <thead>
            <tr>
                <th width="10%" class="bottom left " style="text-align: left;height: 30px;padding: 6px;">PLU</th>
                <th width="40%" class="bottom left " style="text-align: left;height: 30px;padding: 6px;">Description</th>
...
<!--             <tr>
            ...
            <tr>
                ...
                <td colspan="2" class="left top bottom" style="text-align: left;height: 30px;padding: 6px;">Gross Total : </td>
                <td class="top bottom right" style="text-align: right;height: 30px;padding: 6px;"><?php echo number_format($gross_total,2); ?></td>
            </tr>
            <tr>
                <td colspan="4"  class="left bottom" style="text-align: left;height: 30px;padding: 6px;"><?php echo $info->remarks; ?></td>
                <td colspan="2" class="left bottom" style="text-align: left;height: 30px;padding: 6px;">Discount per Item : </td>
                <td class="bottom right" style="text-align: right;height: 30px;padding: 6px;"><?php echo number_format($info->total_discount,2); ?></td>
            </tr>
            <tr>
                <td colspan="4" class="left" style="height: 30px;padding: 6px;"><b>Prepared By:</b></td>
                <td colspan="2" class="left bottom" style="text-align: left;height: 30px;padding: 6px;">Global Discount : </td>
            ...
            <tr>
                ...
                <td colspan="2" class="left bottom" style="text-align: left;height: 30px;padding: 6px;">Total Tax:</td>
            ...
            <tr>
                ...
                <td colspan="2" class="left bottom" style="text-align: left;height: 30px;padding: 6px;"><strong>Tendered:</strong></td>
                <td class="bottom right" style="text-align: right;height: 30px;padding: 6px;"><strong><?php echo number_format($info->total_tendered,2); ?></strong></td>
            </tr>
            <tr>
                <td colspan="4" class="left bottom" style="height: 30px;padding: 6px;"></td>
                <td colspan="2" class="left bottom" style="text-align: left;height: 30px;padding: 6px;"><strong>Change:</strong></td>
                <td class="bottom right" style="text-align: right;height: 30px;padding: 6px;"><strong><?php echo number_format($info->total_change,2); ?></strong></td>
            </tr>            
            </tfoot>
        </table><br /><br />
    </center>
