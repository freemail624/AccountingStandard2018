 ...
 <div style="margin-left: 20px">
     <h2 style="margin-top: 0px!important;">Transaction Details</h2>
     <hr />

     <span>Reference No :</span> <span style="font-size: 14px;font-weight: bolder;"><?php echo $item->ref_no; ?></span><br>
     <span>Parent :</span> <span style="font-size: 14px;font-weight: bolder;"><?php echo $int->department_name; ?></span><br>
     <span>Customer :</span> <span style="font-size: 14px;font-weight: bolder;"><?php echo $int->customer_name; ?></span><br>
