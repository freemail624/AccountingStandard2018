...
<center>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-7">
                                                        ...
                                                        <select name="supplier_id" class="cbo_supplier_list">
                                                            <option value="<?php echo $payment_info->supplier_id; ?>"><?php echo $payment_info->supplier_name; ?></option>
                                                        </select>
                                                    </div>
                                                    <div class="col-lg-5">
                                                        ATC :
                                                ...
                                                <div class="row">
                                                    <div class="col-sm-6">
                                                        ...
                                                        <select class="cbo_customer_list" name="ref_type" data-error-msg="Reference type is required." required>
                                                            <option value="CV" <?php if ($payment_info->receipt_type == 'CV') {
                                                                                    echo 'SELECTED';
                                                                                } ?>>CV</option>
                                                            <option value="JV" <?php if ($payment_info->receipt_type == 'JV') {
                                                                                    echo 'SELECTED';
                                                                                } ?>>JV</option>
                                                        </select>
                                                    </div>
 ...
 -->
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <button name="btn_finalize_journal_review" class="btn btn-primary <?php echo ($is_check_not_due ? 'disabled' : ''); ?> <?php echo (!$valid_particular ? 'disabled' : ''); ?>"><i class="fa fa-check-circle"></i> <span class=""></span> Finalize and Post this Journal</button>
                                    </div>
                                </div>
                            </div>
