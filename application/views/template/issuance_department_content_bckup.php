...
*/
    ...
    <div style="width:100%">
        ...
        <table width="100%" id="issuance" style="border:none!important;">
            ...
            <tbody>
                <tr>
                    <td style="width:20%;text-align:left;font-weight:bold;border:none!important;">From Parent:</td>
                ...
                <tr>
                    ...
                    <td style="width:20%;text-align:left;font-weight:bold;border:none!important;">To Parent:</td>
        ...
        <tr style="background-color: transparent!important;">
            ...
            <th style="width:23%;text-align:center;border-top:1px solid black;">Customer's Signature</th>
                ...
                <tr>
                    ...
                    <th style="width:30%;text-align:center;border-top:1px solid black;">Authorized Signature</th>
                    <th style="width: 10%;"></th>
                    </td>
                    <td style="border:none!important;">
                    <th style="width: 10%;"></th>
                    <th style="width:30%;text-align:center;border-top:1px solid black;">Branch's Signature</th>
                    <th style="width: 10%;"></th>
                    </td>
                </tr>
            </tbody>
