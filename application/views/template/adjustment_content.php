...
<div>    
    ...
    <center>
        <table width="95%" style="border-collapse: collapse;border-spacing: 0;font-family: tahoma;font-size: 11;background-color: transparent!important;" class="nohover" >
            ...
            <tr>
            <td colspan="6" style="text-align: left;font-weight: bolder; ;height: 30px;padding: 6px;border-left: 1px solid gray;border-bottom: 1px solid gray;border-right: 1px solid gray;"><?php echo $adjustment_info->remarks; ?></td>
            </tr>
            </tbody>
            <tfoot style="background-color: transparent!important ;">
            <tr style="background-color: transparent!important ;">
                <td colspan="3" style="text-align: left;height: 30px;padding: 6px;border-left: 1px solid gray;"><b>Prepared by:</b></td>
            ...
            <tr style="background-color: transparent!important ;">
                <td colspan="3" style="text-align: right;height: 30px;padding: 6px;border-left: 1px solid gray;border-bottom: 1px solid gray;"></td>
            ...
            <tr style="background-color: transparent!important ;">
                <td colspan="3" style="text-align: left;height: 30px;padding: 6px;border-left: 1px solid gray;"><b>Received by:</b></td>
            ...
            <tr style="background-color: transparent!important ;">
                <td colspan="3" style="text-align: left;height: 30px;padding: 6px;border-left: 1px solid gray;border-bottom: 1px solid gray;">Date:</td>
