...
<body>
<div class="for_sales_invoice" style="page-break-after: always;">
    <table width="100%">
        <tr class="">
...
<div class="for_deliveryReceipt" style="page-break-after: inherit;">
    <table width="100%">
        <tr class="">
            <td width="50%" valign="top">
                <img src="<?php echo $company_info->logo_path; ?>" style="height: 70px; width: 300px;"> 
    ...
    <br/>  
   <table width="100%" cellpadding="6" class="table table-striped" style="border: 1px solid black;">
        <tr>
            <td width="15%" class="default-color border" valign="top">QTY</td>
