...
<div style="page-break-after: always;">
   ...
   <table width="100%" cellpadding="6" class="table table-striped">
    ...
    <div>
        ...
        <table width="100%">
            <tr>
                <td><strong>Customer Name : </strong><br/> <?php echo $sales_info->customer_name; ?></td>
                <td><strong>SI #: </strong><br/><?php echo $sales_info->sales_inv_no; ?></td>
                <td><strong>Date : </strong><br/><?php echo date('M d,Y', strtotime($sales_info->date_invoice)); ?></td>
            </tr>
        </table>
        <br/>
        <div style="height: 390px!important; min-height: 390px!important;">
            <table width="100%" cellpadding="5">
                ...
                <?php
                    $total_tax_amount = 0;
                    $gross_total = 0;
                    foreach($sales_invoice_items as $items){
                    $total_tax_amount+=$items->inv_tax_amount;
                    $gross_total+=$items->inv_gross;
                    ?>
                    <tr>
                        <td align="center">
                            <input type="checkbox" class="form-control" style="width: 100px!important; height: 100px!important;">
                        </td>
                        <td><?php echo $items->inv_qty; ?></td>
        ...
        <div style="height: 390px!important; min-height: 390px!important;">
            <table width="100%" cellpadding="5">
                ...
                <?php foreach($sales_invoice_items as $items){
                    $price = $items->inv_price - $items->inv_discount;
                    $overall_discount = ($sales_info->total_overall_discount/100);
                ...
                ?>
                    <tr>
                        ...
                        <td align="right"><?php echo number_format($unit_price * $item->inv_qty,2); ?></td>
                    </tr>
                <?php }?>
            </table>
        </div>
