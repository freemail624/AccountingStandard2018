<div style="width:100%;height:430px;">
    ...
    <h4 style="font-weight:bold;">DELIVERY RECEIPT FOR LIVESTOCK<slipno style="float:right;"><?php echo $issuance_info->slip_no; ?></slipno>
    </h4>
    <table class="table">
        <thead>
        </thead>
        <tbody>
            <tr>
                <td style="font-weight:bold;width:20%;">Name of Branch: </td>
