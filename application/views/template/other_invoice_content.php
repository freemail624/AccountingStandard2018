...
.text-right{text-align: right;}
    ...
    <table width="100%" cellspacing="0" cellpadding="0">
        <tr class="row_child_tbl_sales_order" style="height: 100px;" >
            ...
            <td width="30%" style="border: 1px solid black;">
                <center><h2>OTHER INVOICE</h2></center>
                <hr style="color:black!important">
                <?php echo $other_info->other_invoice_no?>
            </td>
        </tr>
    </table>
    <table width="100%" cellpadding="5" cellspacing="0">
        <tr>
            <td class="left bottom fifteen" ><span>Supplier Name:</span></td>
            <td class="bottom "><?php echo $other_info->supplier_name?></td>
                <td class="left bottom fifteen">Date:</td>
                <td class="bottom right "><?php echo  date_format(new DateTime($other_info->date_invoice ),"m/d/Y"); ?></td>
        </tr>
        <tr>
            <td class="left bottom "><span>Contact Person:</span></td>
            <td class="bottom "><?php echo $other_info->contact_person ?></td>
                <td class="left bottom ">Department:</td>
                <td  class="bottom right "><?php echo $other_info->department_name ?></td>
        </tr>
        <tr>
            <td class="left bottom "><span>Due Date</span></td>
            <td class="bottom "><?php echo  date_format(new DateTime($other_info->date_due),"m/d/Y"); ?></td>
                <td class="left bottom ">Salesperson</td>
                <td  class="bottom right "><?php echo $other_info->firstname ?> <?php echo $other_info->lastname ?></td>
        </tr>
    </table>
    <table width="100%"  style="font-family: tahoma;font-size: 11;" cellspacing="0" cellpadding="5">
            ...
            <?php foreach($other_items as $item){ ?>
                <tr>
                    <td width="12%"  class="left" style="text-align: center;height: 30px;padding: 6px;"><?php echo number_format($item->oi_qty,0); ?></td>
                    <td width="50%"   class="left" style="text-align: left;height: 30px;padding: 6px;"><?php echo $item->item_desc; ?></td>

                    <td width="12%"  class="left" style="text-align: center;height: 30px;padding: 6px;"><?php echo $item->item_unit_name; ?></td>
                    <td width="12%"  class="left" style="text-align: right;height: 30px;padding: 6px;"><?php echo number_format($item->oi_price,2); ?></td>
                    <td width="12%"  class="left right" style="text-align: right;height: 30px;padding: 6px;"><?php echo number_format($item->oi_line_total,2); ?></td>
                </tr>
            <?php } ?>
            ...
            <table width="100%" cellspacing="0" cellpadding="5">
                <tr>
                    ...
                    <td style="width: 20%" class="bottom text-right top "><?php echo number_format($other_info->total_amount,2); ?></td>
                    <td style="width: 10%" class="text-right left bottom top "><strong>Discount:</strong></td>
                    <td style="width: 20%" class="bottom text-right top "><?php echo number_format($other_info->total_overall_discount_amount,2); ?></td>
                    <td style="width: 15%" class="text-left left bottom top "><strong>Net Total:</strong></td>
                    <td style="width: 20%" class="right bottom text-right top"><?php echo number_format($other_info->total_amount_after_discount,2); ?></td>
                </tr>
            <tr>
            <td colspan="6" style="text-align: left;font-weight: bolder; ;height: 30px;padding: 6px;" class="left right"><b>Remarks</b> </td>
            </tr>
            <tr>
            <td colspan="6" style="text-align: left;font-weight: bolder; ;height: 30px;padding: 6px;" class="right left bottom"><?php echo $other_info->remarks; ?></td>
            </tr>
                <tr>
