    ...
    <div>
        ...
        <table cellspacing="0" cellpadding="5" width="100%">
            ...
            <tr>
                ...
                <td class="bottom left ">Parent:</td>
        ...
        <center>
            <table width="100%" style="border-collapse: collapse;border-spacing: 0;font-family: tahoma;font-size: 11">
                <thead>
                    <tr>
                        <th width="10%" class="bottom left " style="text-align: left;height: 30px;padding: 6px;">Item</th>
                ...
                <tbody>
                    <?php foreach ($delivery_receipt_items as $item) { ?>
                        <tr>
                            ...
                            <td width="40%" class="left" style="text-align: left;height: 30px;padding: 6px;"><?php echo $item->product_desc; ?></td>
