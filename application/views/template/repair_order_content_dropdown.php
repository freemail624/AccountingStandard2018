	...
	<?php 
		...
		foreach($items as $item){
			...
			if($item->vehicle_service_id == 1){
				...
				$total_pms_amount+=$item->order_gross;
				$pms_count++;
			}
			...
			if($item->vehicle_service_id == 2){
				...
				$total_bpr_amount+=$item->order_gross;
				$bpr_count++;
			}
			...
			if($item->vehicle_service_id == 3){
				...
				$total_gj_amount+=$item->order_gross;
				$gj_count++;
			}
		}
					...
					<div class="col-md-6">
		                <div class="tab-container tab-top tab-primary">
		                    <ul class="nav nav-tabs">
		                        <li class="active">
		                            <a href="#pms_<?php echo $info->repair_order_id; ?>" data-toggle="tab"> Periodic Maintenance (PMS)
