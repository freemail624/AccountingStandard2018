...
<!--     <table width="100%" cellspacing="5" cellspacing="0">
    ...
    <center>
        <table width="100%" style="border-collapse: collapse;border-spacing: 0;font-family: tahoma;font-size: 11">
            <thead>
            <tr>
                <th width="15%" class="bottom left " style="text-align: left;height: 30px;padding: 6px;">Part Number</th>
                <th width="35%" class="bottom left " style="text-align: left;height: 30px;padding: 6px;">Description</th>
                <th width="10%" class="bottom left" style="text-align: center;height: 30px;padding: 6px;">Qty</th>
                <th width="10%" class="bottom left" style="text-align: center;height: 30px;padding: 6px;">UM</th>
                <th width="10%" class="bottom left" style="text-align: right;height: 30px;padding: 6px;">Price</th>
                <th width="10%" class="bottom left" style="text-align: right;height: 30px;padding: 6px;">Gross</th>
                <th width="10%" class="bottom left right" style="text-align: right;height: 30px;padding: 6px;">Net Total</th>
            </tr>
            </thead>
            <tbody>
            <?php foreach($sales_invoice_items as $item){ ?>
                <tr>
                    <td class="left" style="text-align: left;height: 30px;padding: 6px;"><?php echo $item->product_code; ?></td>
                    <td class="left" style="text-align: left;height: 30px;padding: 6px;"><?php echo $item->product_desc; ?></td>
                    <td class="left" style="text-align: right;height: 30px;padding: 6px;"><?php echo number_format($item->inv_qty,2); ?></td>
                    <td class="left" style="text-align: center;height: 30px;padding: 6px;"><?php echo $item->unit_name; ?></td>
                    <td class="left" style="text-align: right;height: 30px;padding: 6px;"><?php echo number_format($item->inv_price,2); ?></td>
                    <td class="left" style="text-align: right;height: 30px;padding: 6px;"><?php echo number_format($item->inv_gross,2); ?></td>
                    <td class="left right" style="text-align: right;height: 30px;padding: 6px;"><?php echo number_format($item->inv_line_total_price,2); ?></td>
                </tr>
            <?php } ?>
<!--             <tr>
            ...
            <tr>
                ...
                <td colspan="2" class="top bottom right" style="text-align: right;height: 30px;padding: 6px;"><?php echo number_format($sales_info->total_discount,2); ?></td>
            </tr>
            <tr>
                ...
                <td colspan="2" class="bottom right" style="text-align: right;height: 30px;padding: 6px;"><?php echo number_format($sales_info->total_before_tax,2); ?></td>
            </tr>
            <tr>
                ...
                <td colspan="2" class="bottom right" style="text-align: right;height: 30px;padding: 6px;"><?php echo number_format($sales_info->total_tax_amount,2); ?></td>
            </tr>
            <tr>
                ...
                <td colspan="2" class="bottom right" style="text-align: right;height: 30px;padding: 6px;"><?php echo number_format($sales_info->total_after_tax,2); ?></td>
            </tr>
            <tr>
                ...
                <td colspan="2" class="bottom right" style="text-align: right;height: 30px;padding: 6px;"><?php echo number_format($sales_info->total_overall_discount_amount,2); ?></td>
            </tr>
            <tr>
                ...
                <td colspan="2" class="bottom right" style="text-align: right;height: 30px;padding: 6px;"><strong><?php echo number_format($sales_info->total_after_discount,2); ?></strong></td>
            </tr>
            </tfoot>
        </table><br /><br />
    </center>
