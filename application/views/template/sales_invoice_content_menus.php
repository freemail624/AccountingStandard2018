...
<!--             <a href="Templates/layout/sales-invoice/<?php echo $sales_info->sales_invoice_id; ?>?type=contentview" target="_blank" class="btn btn-default" style="text-transform:none;font-family: tahoma;" ><i class="fa fa-print"></i> Print Sales Invoice</a>
            ...
            <a href="Templates/layout/sales-invoice/<?php echo $sales_info->sales_invoice_id; ?>?type=direct" target="_blank" class="btn btn-default" style="text-transform:none;font-family: tahoma;" ><i class="fa fa-print"></i> Print Direct Invoice </a>
        </div>
    </div>
