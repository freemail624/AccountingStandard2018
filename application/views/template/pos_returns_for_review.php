            ...
            <td>
                ...
                <div class="tab-container tab-top tab-default">
                    <ul class="nav nav-tabs">
                        ...
                        <!-- <li class=""><a href="#purchase_review_<?php echo $return_info->x_reading_id; ?>" data-toggle="tab"><i class="fa fa-folder-open-o"></i> Transaction</a></li> -->
                    </ul>
...
<!--                         <div class="tab-pane" id="purchase_review_<?php echo $return_info->x_reading_id; ?>" >
