            ...
            <td>
                ...
                <div class="tab-container tab-top tab-default">
                    <ul class="nav nav-tabs">
                        <li class="active"><a href="#journal_review_<?php echo $return_info->x_reading_id; ?>" data-toggle="tab"><i class="fa fa-gavel"></i> Review Journal</a></li>
                        <li class=""><a href="#sales_return_review_<?php echo $return_info->x_reading_id; ?>" data-toggle="tab"><i class="fa fa-folder-open-o"></i> Transaction</a></li>
                    </ul>
                    <div class="tab-content">
                        <div class="tab-pane active" id="journal_review_<?php echo $return_info->x_reading_id; ?>" data-parent-id="<?php echo $return_info->x_reading_id; ?>" style="min-height: 300px;">
                            <form id="frm_journal_review" role="form" class="form-horizontal row-border">
                                <input type="hidden" name="x_reading_id" value="<?php echo $return_info->x_reading_id; ?>">
                                <input type="hidden" name="ref_no" value="<?php echo $return_info->x_reading_id;?>">
                                ...
                                <div style="width: 90%;">
                                    ...
                                    <div class="col-lg-10">
                                        <input type="text" name="date_txn" class="date-picker  form-control" value="<?php echo $return_info->trans_date; ?>">
                                    </div>
                                    <br /><br />
                                ...
                                <hr />
                                <table id="tbl_entries_for_review_adj<?php echo $return_info->x_reading_id; ?>" class="table table-striped" style="width: 100% !important;">
                                    <thead>
                        ...
                        <div class="tab-pane" id="sales_return_review_<?php echo $return_info->x_reading_id; ?>" >
                                <h4><span style="margin-left: 1%"><strong><i class="fa fa-bars"></i> POS - Sales Return</strong></span></h4>
                                <hr />
