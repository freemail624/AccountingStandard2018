                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="journal_review_<?php echo $sales_info->sales_invoice_id; ?>" data-parent-id="<?php echo $sales_info->sales_invoice_id; ?>" style="min-height: 300px;">
                                ...
                                <form id="frm_journal_review" role="form" class="form-horizontal row-border">
                                    ...
                                    <div class="col-lg-12">
                                        <textarea name="remarks" class="form-control" style="width: 100%;"><?php echo $sales_info->remarks; ?></textarea>
                                    </div>
                                    <br />
                                    <hr />
                                </form>
                                    ...
                                    <div class="col-lg-12">
                                        <div class="col-sm-6">
                                            <button name="btn_finalize_journal_review" class="btn btn-primary  <?php if (!$valid_particular) {
                                                                                                                    echo "disabled";
                                                                                                                } ?>"><i class="fa fa-check-circle"></i> <span class=""></span> Finalize and Post this Journal</button>
                                        </div>
                                        <div class="col-sm-6">
                            ...
                            <div class="tab-pane" id="purchase_review_<?php echo $sales_info->sales_invoice_id; ?>">
                                ...
                                <div style="margin-left: 2%">
                                    <div class="row">
                                        ...
                                        <div class="col-lg-6">
                                            <i class="fa fa-users"></i> Branch : <?php echo $sales_info->customer_name; ?><br />
