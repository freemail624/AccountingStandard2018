...
<body>
	...
	<div class="row" style="margin: 0px;">
		...
		<div class="col-md-12">
			...
			<div class="col-md-4">
				Department : <br>
				<select name="department_id" class="form-control fixed_asset cbo_item_departments" id="cbo_item_departments_<?php echo $items->dr_invoice_item_id; ?>" data-error-msg="Department is required.">
