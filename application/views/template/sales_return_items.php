<?php foreach($items as $item){ ?>
	<tr>
		<td width="15%">
			<input type="text" class="numeric form-control" name="return_qty[]"
		...
		<td width="35%"><?php echo $item->product_desc; ?></td>
		...
		<td width="20%">
			...
			value="<?php echo $item->adjust_line_total_price > 0 ? $item->adjust_line_total_price : ''?>">
		</td>
	</tr>
<?php }?>