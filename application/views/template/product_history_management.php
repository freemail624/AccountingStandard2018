...
<a href="Products/transaction/history-product-management?id=<?php  echo $product_id?>&type=print&inv=parent" class="btn btn-success btn-sm" name=""  target="_blank" data-toggle="tooltip" data-placement="top" title="Print Bulk Product History" style="margin-right:-5px;"><i class="fa fa-print"></i> Print</a>
