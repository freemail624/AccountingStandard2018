    ...
    <div class="container-fluid">
        ...
        <table class="" width="100%" style="border: 2px solid #757575">
            <tr>
                ...
                <td class="table-cellpadding" width="30%"><strong><?php if ($_GET['category'] == 1) {
                                                                        echo $sales_info->customer_name;
                                                                    } else {
                                                                        echo $sales_info->department_name;
                                                                    } ?></strong></td>
        ...
        <table width="100%" cellpadding="10" class="table-border">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    } ?>" width="30%"><?php echo number_format($sales_info->total_before_tax, 2); ?></td>
                </tr>
                <tr>
        ...
        <table class="table-border" width="100%">
            <tbody>
                ...
                <tr style="text-align: center;">
                    ...
                    <td class="table-cellpadding">Branch / Authorized Representative (Print Name Over Signature / Date)</td>
                </tr>
            </tbody>
        </table>
    </div>
