                        ...
                        <div class="tab-pane active" id="journal_review_<?php echo $purchase_info->dr_invoice_id; ?>" data-parent-id="<?php echo $purchase_info->dr_invoice_id; ?>" style="min-height: 300px;">
                            ...
                            <input type="hidden" name="ref_no" value="<?php echo $purchase_info->dr_invoice_no; ?>">
                                ...
                                <div style="width: 90%;">
                                    ...
                                    <input type="hidden" name="purchase_journal_id" value="<?php echo $info->purchase_journal_id; ?>">
                                    ...
                                    <div class="col-lg-10">
                                        <input type="text" name="date_txn" class="date-picker  form-control" value="<?php echo date("m/d/Y", strtotime($info->date_txn)); ?>">
                                    </div>
                                    <br /><br />
                                    ...
                                    <div class="col-lg-10">
                                        <select name="supplier_id" class="cbo_supplier_list" data-error-msg="Input Tax Account is required." required>
                                            <?php foreach($suppliers as $supplier){ ?>
                                                <option value="<?php echo $supplier->supplier_id; ?>" <?php echo ($info->supplier_id===$supplier->supplier_id?'selected':''); ?>>
                                    ...
                                    <?php
                                        ...
                                        <tr>
                                            ...
                                            <td><select  name="department_id_line[]" class="dept show-tick form-control selectpicker" data-live-search="true" > 
                                                ...
                                                <?php foreach($departments as $department){ ?> 
                                                    <option value='<?php echo $department->department_id; ?>' <?php echo ($entry->department_id===$department->department_id?'selected':''); ?>>
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                <div class="col-sm-6">  
                                    <button name="btn_finalize_journal_review" class="btn btn-primary <?php if(!$valid_particular){ echo "disabled"; }?>"><i class="fa fa-check-circle"></i> <span class=""></span> Finalize & Post Journal</button>
                                </div>
                                <div class="col-sm-4">
                                ...
                                <div class="col-sm-2">  
                                    <button name="btn_cancel_journal_posting" class="btn btn-danger" title="Cancel Journal" style="float: right;margin-top: 5px;"> <i class="fa fa-times-circle"></i> Cancel Invoice</button>
                                </div>
                                </div>
                            </div>
                        </div>
