...
<table width="100%" style="border-collapse: collapse;" cellspacing="5" cellpadding="5">
    <tr>
        ...
        <td width="20%" class="border-right border-bottom" align="right">COST PRICE</td>
    ...
    <?php 
        ...
        $subtotal+=$item->issue_line_total_price;
    ?>
        <tr>
    ...
    <?php foreach($issue_items as $item){
        if($is_basyo->basyo_product_id == $item->product_id){ ?>
    <tr>
        <td valign="top"><center><?php echo number_format($item->issue_qty,2); ?></center></td>
        <td valign="top"><?php echo $item->unit_code; ?></td>
        <td valign="top"><?php echo $item->product_desc; ?></td>
        <td valign="top" align="right"><?php echo number_format($item->issue_price-$item->issue_discount,2); ?></td>
        <td valign="top" align="right"><?php echo number_format($item->issue_line_total_price,2); ?></td>
    </tr>
    <?php }}?>
    <tr>
...
<table width="100%" style="border-collapse: collapse;" cellspacing="5" cellpadding="5">
    ...
    <tr>
        <td colspan="5" style="font-size: 9pt!important;">
            ENCODED BY : <?php echo $issuance_info->encoded_by; ?><br/>
            CHECKED BY : </td>
    </tr>
    <tr>
