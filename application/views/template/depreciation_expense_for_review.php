                ...
                <td>
                    ...
                    <div class="tab-container tab-top tab-default">
                        <ul class="nav nav-tabs">
                            <li class="<?php if ($info->is_journal_posted == 0) {
                                            echo 'active';
                                        } else {
                                            echo '';
                                                                                                                        ...
                                                                                                                        echo '';
                                                                                                                    } ?>><a href="#journal_review_<?php echo $info->de_id; ?>" data-toggle="tab"><i class="fa fa-gavel"></i> Review Journal</a></li>
                            <li class="<?php if ($info->is_journal_posted == 1) {
                                            echo 'active';
                                        } else {
                                            echo '';
                                        } ?>" <?php if ($info->is_journal_posted == 0) {
                                                                                                                        echo 'style="display:none;"';
                                                                                                                    } else {
                                                                                                                        echo '';
                                                                                                                    } ?>><a href="#purchase_review_<?php echo $info->de_id; ?>" data-toggle="tab"><i class="fa fa-folder-open-o"></i> Transaction</a></li>
                        </ul>
                        <div class="tab-content">
                            <div class="tab-pane <?php if ($info->is_journal_posted == 0) {
                                                        echo 'active';
                                                    } else {
                                                        echo '';
                                                    } ?>" id="journal_review_<?php echo $info->de_id; ?>" data-parent-id="<?php echo $info->de_id; ?>" style="min-height: 300px;">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <button name="btn_finalize_journal_review" class="btn btn-primary <?php if ($info->is_journal_posted == 1) {
                                                                                                                echo 'disabled';
                                                                                                            } ?>"><i class="fa fa-check-circle"></i> <span class=""></span> Finalize this Journal</button>
                                    </div>
                                </div>
                            </div>

                            <div class="tab-pane <?php if ($info->is_journal_posted == 1) {
                                                        echo 'active';
                                                    } else {
                                                        echo '';
                                                    } ?>" id="purchase_review_<?php echo $info->de_id; ?>">
                                <h4><span style="margin-left: 1%"><strong><i class="fa fa-bars"></i><?php if ($info->is_journal_posted == 1) {
                                                                                                        echo ' POSTED';
                                                                                                    } else {
                                                                                                        echo ' FOR POSTING';
                                                                                                    } ?> </strong></span></h4>
