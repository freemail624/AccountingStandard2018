...
<body>
	...
	<table width="100%" cellpadding="10" cellspacing="-1" class="table table-striped" style="text-align: center;">
        ...
        <tr>
        	<td align="left" colspan="1" style="border-left: 1px solid gray;"><b>Prepared By:</b></td>
        	...
        	<td colspan="2" style="padding: 6px;border-bottom: 1px solid gray;height: 30px; border-right: 1px solid gray;" align="right"><?php echo number_format($purchase_info->total_discount,4); ?></td>
        </tr>
        <tr>
            <td  align="left" colspan="1"  style="border-bottom: 1px solid gray;border-left: 1px solid gray;"></td>
            ...
            <td colspan="2" style="padding: 6px;border-bottom: 1px solid gray;height: 30px;border-right: 1px solid gray;" align="right"><?php echo number_format($purchase_info->total_before_tax,4); ?></td>
        </tr>
        <tr>
        	<td align="left" colspan="1" style="border-left: 1px solid gray;"><b>Received By:</b></td>
        	...
        	<td colspan="2" style="padding: 6px;border-bottom: 1px solid gray;height: 30px;border-right: 1px solid gray;" align="right"><?php echo number_format($purchase_info->total_tax_amount,4); ?></td>
        </tr>
        <tr>
        	<td align="left" colspan="1" style="border-left: 1px solid gray;" ></td>
        	...
        	<td colspan="2" style="padding: 6px;border-bottom: 1px solid gray;height: 30px;border-right: 1px solid gray;" align="right"><?php echo number_format($purchase_info->total_after_tax,4); ?></td>
        </tr>
        <tr>
       		<td align="left" colspan="1"  style="border-bottom: 1px solid gray;border-left: 1px solid gray;">Date</td>
        	...
        	<td colspan="2" style="padding: 6px;border-bottom: 1px solid gray;height: 30px;border-right: 1px solid gray;" align="right"><?php echo number_format($purchase_info->total_overall_discount_amount,4); ?></td>
        </tr>
        <tr>
            <td align="left" colspan="1"  style="border-bottom: 1px solid gray;border-left: 1px solid gray;"></td>
            ...
            <td colspan="2" style="padding: 6px;border-bottom: 1px solid gray;height: 30px;border-right: 1px solid gray;" align="right"><strong><?php echo number_format($purchase_info->total_after_discount,4); ?></strong></td>
        </tr>
	</table>
