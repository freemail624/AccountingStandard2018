                                        ...
                                        <div style="border: 1px solid lightgrey;padding: 2%;border-radius: 5px;">
                                            ...
                                            <div class="row">
                                                <div class="col-lg-7">
                                                    ...
                                                    <select name="particular_id" class="cbo_customer_list" required data-error-msg="Customer is required!">
                                                ...
                                                <div class="col-lg-4 col-lg-offset-1">
                                                    ...
                                                    <div class="input-group">
                                                        <input type="text" name="date_txn" class="date-picker  form-control" value="<?php echo $info->date_txn; ?>" required data-error-msg="Date is required!">
