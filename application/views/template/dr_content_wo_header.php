    ...
    <center>
        <table width="95%" style="border-collapse: collapse;border-spacing: 0;font-family: tahoma;font-size: 11" >
            ...
            <tr>
                ...
                <th width="12%" style="border-bottom: 2px solid gray;text-align: right;height: 30px;padding: 6px;">SRP</th>
            ...
            <?php foreach($dr_items as $item){ ?>
                <tr>
                    ...
                    <td width="12%" style="border-bottom: 1px solid gray;text-align: right;height: 15px;padding: 6px;"><?php echo number_format($item->sale_price,2); ?></td>

                    <td width="12%" style="border-bottom: 1px solid gray;text-align: right;height: 15px;padding: 6px;"><?php echo number_format($item->dr_line_total_after_global,2); ?></td>
                </tr>
            <?php } ?>
            <tr>
            ...
            <tr>
            <td colspan="6" style="text-align: left;font-weight: bolder; ;height: 30px;padding: 6px;border-left: 1px solid gray;border-bottom: 1px solid gray;border-right: 1px solid gray;"><?php echo $delivery_info->remarks; ?></td>
            </tr>
            </tbody>
            <tfoot>
            <tr>
                <td align="left" colspan="2" style="border-left: 1px solid gray;padding: 6px;"><b>Prepared By:</b></td>
                <td colspan="3" style="padding: 6px;border-bottom: 1px solid gray;height: 15px;border-left: 1px solid gray;" align="left">Global Discount %:</td>
            ...
            <tr>
                ...
                <td colspan="3" style="border-bottom: 1px solid gray;text-align: left;height: 15px;padding: 6px;border-left: 1px solid gray;">Discount 2 : </td>
            ...
            <tr>
                ...
                <td colspan="3" style="padding: 6px;border-bottom: 1px solid gray;height: 15px;border-left: 1px solid gray;" align="left">Total Before Tax:</td>
            ...
            <tr>
                ...
                <td colspan="3" style="border-bottom: 1px solid gray;text-align: left;height: 15px;padding: 6px;border-left: 1px solid gray;">Tax Amount : </td>
            ...
            <tr>
                ...
                <td colspan="3" style="border-bottom: 1px solid gray;text-align: left;height: 15px;padding: 6px;border-left: 1px solid gray;">Total After Tax : </td>
            ...
            <tr>
                ...
                <td colspan="3" style="border-bottom: 1px solid gray;text-align: left;height: 15px;padding: 6px;border-left: 1px solid gray;"><strong>Total: </strong></td>
