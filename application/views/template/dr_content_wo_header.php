        ...
        <table width="95%" style="border-collapse: collapse;border-spacing: 0;font-family: tahoma;font-size: 11" >
            ...
            <?php foreach($dr_items as $item){ ?>
                <tr>
                    ...
                    <td width="12%" style="border-bottom: 1px solid gray;text-align: right;height: 15px;padding: 6px;"><?php echo number_format($item->dr_qty,4); ?></td>
                    <td width="12%" style="border-bottom: 1px solid gray;text-align: center;height: 15px;padding: 6px;"><?php echo $item->unit_name; ?></td>
                    <td width="12%" style="border-bottom: 1px solid gray;text-align: right;height: 15px;padding: 6px;"><?php echo number_format($item->dr_price,4); ?></td>

                    <td width="12%" style="border-bottom: 1px solid gray;text-align: right;height: 15px;padding: 6px;"><?php echo number_format($item->dr_line_total_price,4); ?></td>
                </tr>
            <?php } ?>
            <tr>
            ...
            <tr>
                ...
                <td style="padding: 6px;border-bottom: 1px solid gray;height: 15px;border-right: 1px solid gray;" align="right"><?php echo number_format($delivery_info->total_discount,4); ?></td>
            </tr>
            <tr>
                ...
                <td style="padding: 6px;border-bottom: 1px solid gray;height: 15px;border-right: 1px solid gray;" align="right"><?php echo number_format($delivery_info->total_before_tax,4); ?></td>
            </tr>
            <tr>
                ...
                <td style="border-bottom: 1px solid gray;text-align: right;height: 15px;padding: 6px;border-right: 1px solid gray;"><?php echo number_format($delivery_info->total_tax_amount,4); ?></td>
            </tr>
            <tr>
                ...
                <td style="border-bottom: 1px solid gray;text-align: right;height: 15px;padding: 6px;border-right: 1px solid gray;"><?php echo number_format($delivery_info->total_after_tax,4); ?></td>
            </tr>
            <tr>
                ...
                <td style="border-bottom: 1px solid gray;text-align: right;height: 15px;padding: 6px;border-right: 1px solid gray;"><?php echo number_format($delivery_info->total_overall_discount_amount,4); ?></td>
            </tr>
            <tr>
                ...
                <td style="border-bottom: 1px solid gray;text-align: right;height: 15px;padding: 6px;border-right: 1px solid gray;"><strong><?php echo number_format($delivery_info->total_after_discount,4); ?></strong></td>
            </tr>
            </tfoot>
        </table><br /><br />
    </center>
