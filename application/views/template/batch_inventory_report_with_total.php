    ...
    <table width="100%" >
        <thead>
            <tr>
                ...
                <td width="15%" align="right">SRP</td>
        ...
        <tbody>
            ...
            <tr>
                ...
                <td valign="top" align="right"><?php echo number_format((round($product->total_cost,2)),2); ?></td>
            </tr>
            <?php 
            ...
            <?php if(count($products)==0){ ?>
                <tr>
                    <td colspan="11" style="height: 40px;"><center>No records found.</center></td>
                </tr>
            <?php } ?>
        </tbody>
        <tfoot>
