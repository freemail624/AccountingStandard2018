...
<div class="row" >
    <div class="col-lg-12">
        <div class="title-action" style="margin-left: 3%;">
            ...
            <button name="mark_as_cancelled_voucher" type="button" class="btn btn-danger" style="text-transform: none;"><i class="fa fa-times-circle"></i> <span class=""></span> Disapprove and Cancel </button>
