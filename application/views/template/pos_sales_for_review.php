            ...
            <td>
                ...
                <div class="tab-container tab-default" >
                    <ul class="nav nav-tabs">
                        <li class="active"><a href="#journal_review_<?php echo $info->x_reading_id; ?>" data-toggle="tab"><i class="fa fa-gavel"></i> Review Journal</a></li>
                        <!-- <li class=""><a href="#payment_review_<?php echo $info->x_reading_id; ?>" data-toggle="tab"><i class="fa fa-folder-open-o"></i> Payment</a></li> -->
                    </ul>
                    <div class="tab-content">
                        <div class="tab-pane active" id="journal_review_<?php echo $info->x_reading_id; ?>" data-parent-id="<?php echo $info->x_reading_id; ?>" style="min-height: 300px;">
                            <form id="frm_journal_review" role="form" class="form-horizontal row-border">
                                <br />
                                <input type="hidden" name="x_reading_id" value="<?php echo $info->x_reading_id; ?>">
                                <input type="hidden" name="ref_no" value="<?php echo $info->x_reading_id;?>">
                                <div class="row">
                                    <div class="col-lg-8">
                                        <div style="border: 1px solid lightgrey;padding: 2%;border-radius: 5px;">
                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-lg-4 col-lg-offset-1">
                                                    Date * :<br />
                                                    <div class="input-group">
                                                        <input type="text" name="date_txn" class="date-picker  form-control" value="<?php echo $info->trans_date; ?>">
                                                        <span class="input-group-addon">
                                                            <i class="fa fa-calendar"></i>
                                                        </span>
                                                    </div>
                                ...
                                <hr />
                                <table id="tbl_entries_for_review_<?php echo $info->x_reading_id; ?>" class="table table-striped" style="width: 100% !important;">
                                    <thead>
