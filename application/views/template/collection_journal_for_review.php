                    ...
                    <div class="tab-container tab-default">
                        ...
                        <div class="tab-content">
                            <div class="tab-pane active" id="journal_review_<?php echo $payment_info->payment_id; ?>" data-parent-id="<?php echo $payment_info->payment_id; ?>" style="min-height: 300px;">
                                ...
                                <div class="row">
                                    <div class="col-lg-12">
                                        <button name="btn_finalize_journal_review" class="btn btn-primary <?php echo ($is_check_not_due ? 'disabled' : ''); ?> <?php if (!$valid_particular) {
                                                                                                                                                                    echo "disabled";
                                ...
                                <div style="margin-left: 2%">
                                    <div class="row">
                                        <div class="col-lg-6">
                                            ...
                                            <i class="fa fa-users"></i> Branch : <?php echo $payment_info->customer_name; ?><br /><br />
                                        </div>
                                        <div class="col-lg-6">
