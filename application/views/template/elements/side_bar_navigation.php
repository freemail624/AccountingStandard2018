                    ...
                    <ul class="acc-menu">
                        ...
                        <li class="<?php echo (in_array('1',$this->session->parent_rights)?'':'hidden'); ?>"><a href="#/"><i class="ti ti-wallet"></i><span>Financing</span></a>
                            <ul class="acc-menu">
                                ...
                                <li class="<?php echo (in_array('1-7',$this->session->user_rights)?'':'hidden'); ?>"><a href="Service_journal">Service Journal</a></li>
                        ...
                        <li class="<?php echo (in_array('13',$this->session->parent_rights)?'':'hidden'); ?>"><a href="#/"><i class="fa fa-car"></i><span>Services</span></a>
                            <ul class="acc-menu">
                                ...
                                <li class="<?php echo (in_array('3-3',$this->session->user_rights)?'':'hidden'); ?>"><a href="Service_report">Service Report</a></li>
 ...
 -->
                        ...
                        <li class="<?php echo (in_array('15',$this->session->parent_rights)?'':'hidden'); ?>"><a href="#/"><i class="ti ti-stats-up"></i><span>Inventory</span></a>
                            <ul class="acc-menu">
                                ...
                                <li class="<?php echo (in_array('15-2',$this->session->user_rights)?'':'hidden'); ?>"><a href="Issuances">Parts Req &amp; Issuance Slip</a></li>
...
<!--                                 <li  class="<?php //echo (in_array('4-15',$this->session->user_rights)?'':'hidden'); ?>"><a href="product_locations">Product Location</a></li> -->
...
<!--                         <li class="<?php echo (in_array('10',$this->session->parent_rights)?'':'hidden'); ?>"><a href="#/"><i class="ti ti-bag"></i><span>Assets Management</span></a>
                            <ul class="acc-menu">
                                ...
                                <li class="<?php echo (in_array('10-3',$this->session->user_rights)?'':'hidden'); ?>"><a href="Asset_movement">Movement of Assets</a></li>
