            ...
            <div class="widget stay-on-collapse" id="widget-sidebar">
                <nav role="navigation" class="widget-body">
                    <ul class="acc-menu">
                        ...
                        <li class="<?php //echo (in_array('13',$this->session->parent_rights)?'':'hidden'); 
                                    ?>"><a href="#/"><i class="ti ti-view-list-alt"></i><span>Services</span></a>
                            <ul class="acc-menu">
                                <li class="<?php //echo (in_array('13-1',$this->session->user_rights)?'':'hidden'); 
                                            ?>"><a href="Service_invoice">Service Invoice</a></li>
                                <li class="<?php //echo (in_array('13-2',$this->session->user_rights)?'':'hidden'); 
                                            ?>"><a href="Service_journal">Service Journal</a></li>
                                <li class="<?php //echo (in_array('13-3',$this->session->user_rights)?'':'hidden'); 
                                            ?>"><a href="Service_unit">Service Unit</a></li>
                                <li class="<?php //echo (in_array('13-4',$this->session->user_rights)?'':'hidden'); 
                                            ?>"><a href="Services">Service Management</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="<?php echo (in_array('3', $this->session->parent_rights) ? '' : 'hidden'); ?>"><a href="#/"><i class="ti ti-shopping-cart"></i><span>Sales</span></a>
                            <ul class="acc-menu">
                                ...
                                <!-- <li class="<?php //echo (in_array('3-5',$this->session->user_rights)?'':'hidden'); 
                                                ?>"><a href="Dispatching">Warehouse Dispatching</a></li> -->

                                <!--                                 <li class="<?php //echo (in_array('3-8',$this->session->user_rights)?'':'hidden'); 
                                                                                ?>"><a href="Loading">Loading Report</a></li> -->

                                <li class="<?php echo (in_array('3-7', $this->session->user_rights) ? '' : 'hidden'); ?>"><a href="Customer_sale_history">Branch Sales History</a></li>
                        ...
                        <!-- 
                        <li class="<?php //echo (in_array('17',$this->session->parent_rights)?'':'hidden'); 
                                    ?>"><a href="#/"><i class="fa fa-folder"></i><span>Office Forms</span></a>
                            <ul class="acc-menu">
                                <li class="<?php //echo (in_array('17-1',$this->session->user_rights)?'':'hidden'); 
                                            ?>"><a href="Cash_request">Cash Request</a></li>
                                <li class="<?php //echo (in_array('17-2',$this->session->user_rights)?'':'hidden'); 
                                            ?>"><a href="Travel_order">Travel Order</a></li>
                                <li class="<?php //echo (in_array('17-3',$this->session->user_rights)?'':'hidden'); 
                                            ?>"><a href="Incident_report">Incident Report</a></li>
                                <li class="<?php //echo (in_array('17-4',$this->session->user_rights)?'':'hidden'); 
                                            ?>"><a href="Accomplishment_report">Accomplishment Report</a></li>
                            </ul>
                        </li> -->
                        ...
                        <li class="<?php echo (in_array('4', $this->session->parent_rights) ? '' : 'hidden'); ?>"><a href="#/"><i class="ti ti-view-list-alt"></i><span>References</span></a>
                            <ul class="acc-menu">
                                ...
                                <li class="<?php echo (in_array('4-3', $this->session->user_rights) ? '' : 'hidden'); ?>"><a href="departments">Parent Management</a></li>
                        ...
                        <li class="<?php echo (in_array('5', $this->session->parent_rights) ? '' : 'hidden'); ?>"><a href="#/"><i class="ti ti-harddrive"></i><span>Masterfiles</span></a>
                            <ul class="acc-menu">
                                ...
                                <li class="<?php echo (in_array('5-3', $this->session->user_rights) ? '' : 'hidden'); ?>"><a href="customers">Branch Management</a></li>
                                <li class="<?php echo (in_array('5-4', $this->session->user_rights) ? '' : 'hidden'); ?>"><a href="Salesperson">Salesperson Management</a></li>
                                <!--                                 <li class="<?php //echo (in_array('5-5',$this->session->user_rights)?'':'hidden'); 
                                                                                ?>"><a href="Agent">Agent Management</a></li> -->
                            </ul>
                        </li>
                        ...
                        <!--                         <li class="<?php //echo (in_array('10',$this->session->parent_rights)?'':'hidden'); 
                                                                ?>"><a href="#/"><i class="ti ti-bag"></i><span>Assets Management</span></a>
                            <ul class="acc-menu">
                                <li class="<?php //echo (in_array('10-1',$this->session->user_rights)?'':'hidden'); 
                                            ?>"><a href="Fixed_asset_management">Fixed Asset Management</a></li>
                                <li class="<?php //echo (in_array('10-3',$this->session->user_rights)?'':'hidden'); 
                                            ?>"><a href="Asset_movement">Movement of Assets</a></li>
                                <li class="<?php //echo (in_array('10-2',$this->session->user_rights)?'':'hidden'); 
                                            ?>"><a href="Depreciation_expense">Depreciation Expense Report</a></li>
                            </ul>
                        </li> -->
                        <!--                         <li class="<?php //echo (in_array('15',$this->session->parent_rights)?'':'hidden'); 
                                                                ?>"><a href="#/"><i class="ti ti-file"></i><span>Bir Forms</span></a>
                            <ul class="acc-menu">
                                <li class="<?php //echo (in_array('15-1',$this->session->user_rights)?'':'hidden'); 
                                            ?>"><a href="Form_2307">Form 2307</a></li>
                        ...
                        <li class="<?php echo (in_array('6', $this->session->parent_rights) ? '' : 'hidden'); ?>">
                            ...
                            <ul class="acc-menu">
                                ...
                                <!--                                 <li class="<?php echo (in_array('6-15', $this->session->user_rights) ? '' : 'hidden'); ?>"><a href="Asset_settings">Fixed Asset Settings</a></li> -->
                        ...
                        <li class="<?php echo (in_array('9', $this->session->parent_rights) ? '' : 'hidden'); ?>">
                            ...
                            <ul class="acc-menu parent-menu">
                                <li class="hasChild secondChild">
                                    ...
                                    <ul class="acc-menu">
                                        <li class="<?php echo (in_array('9-6', $this->session->user_rights) ? '' : 'hidden'); ?>"><a href="Customer_Subsidiary">Branch Subsidiary</a></li>
                        ...
                        <li class="<?php echo (in_array('12', $this->session->parent_rights) ? '' : 'hidden'); ?>"><a href="#/"><i class="ti ti-view-list-alt"></i><span>List</span></a>
                            <ul class="acc-menu">
                                ...
                                <li class="<?php echo (in_array('12-8', $this->session->user_rights) ? '' : 'hidden'); ?>"><a href="Open_purchase_request">Open Purchase Requests</a></li>
