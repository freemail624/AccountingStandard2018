                    ...
                    <ul class="acc-menu">
                        ...
                        <li class="<?php echo (in_array('1',$this->session->parent_rights)?'':'hidden'); ?>"><a href="#/"><i class="ti ti-wallet"></i><span>Financing</span></a>
                            <ul class="acc-menu">
                                ...
                                <li class="<?php echo (in_array('1-9',$this->session->user_rights)?'':'hidden'); ?>"><a href="Check_summary">Check Summary</a></li>
                            </ul>
                        </li>
                        ...
                        <li class="<?php echo (in_array('4',$this->session->parent_rights)?'':'hidden'); ?>"><a href="#/"><i class="ti ti-view-list-alt"></i><span>References</span></a>
                            <ul class="acc-menu">
                                ...
                                <li  class="<?php echo (in_array('4-9',$this->session->user_rights)?'':'hidden'); ?>"><a href="supplier_branches">Supplier Branch Management</a></li>
                            ...
                            <ul class="acc-menu parent-menu">
                                <li class="hasChild secondChild">
                                    ...
                                    <ul class="acc-menu">
                                        ...
                                        <li class="<?php echo (in_array('9-28',$this->session->user_rights)?'':'hidden'); ?>"><a href="Accounts_receivable_tenants">AR Schedule - Tenants</a></li>
