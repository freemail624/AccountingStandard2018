...
<body>
	...
	<table width="100%"  cellspacing="-1" style="border-collapse: collapse;" cellpadding="3" cellspacing="3">
		<tr>
	...
	<br>
	<table width="100%" cellpadding="8" cellspacing="-1" class="table table-striped" style="text-align: center;border-collapse: collapse;">
		<tr>
