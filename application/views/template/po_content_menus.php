    ...
    <div class="col-lg-12">
        <div class="title-action" style="margin-left: 3%;">
           <!--  <a id="btn_email" data-supplier-email="<?php echo $purchase_info->email_address; ?>" class="btn btn-primary <?php echo ($purchase_info->approval_id==2?'disabled':''); ?>" style="text-transform:none;font-family: tahoma;" ><i class="fa fa-envelope"></i> <span class=""></span> Email to Supplier</a> -->
            <a href="Templates/layout/po/<?php echo $purchase_info->purchase_order_id; ?>?type=tsb" target="_blank" class="btn btn-default" style="text-transform:none;font-family: tahoma;" ><i class="fa fa-print"></i> Print PO TSB FORMAT </a>
...
<!--     <div class="col-lg-12">
        <div class="title-action" style="margin-left: 3%;">
             <a id="btn_email" data-supplier-email="<?php //echo $purchase_info->email_address; ?>" class="btn btn-primary <?php //echo ($purchase_info->approval_id==2?'disabled':''); ?>" style="text-transform:none;font-family: tahoma;" ><i class="fa fa-envelope"></i> <span class=""></span> Email to Supplier</a>
            <a href="Templates/layout/po/<?php //echo $purchase_info->purchase_order_id; ?>?type=tsb" target="_blank" class="btn btn-default <?php //echo ($purchase_info->approval_id==2?'disabled':''); ?>" style="text-transform:none;font-family: tahoma;" ><i class="fa fa-print"></i> Print PO TSB FORMAT </a>
