...
<head>
    ...
    <style>
        ...
        .btn-default:focus,
        .btn-default.focus {
            color: #000000 background-color: #090909;
...
<body class="animated-content">
                                        ...
                                        <div id="div_tax_list">
                                            <div class="panel panel-default">
                                                <div class="panel-body table-responsive" style="box-shadow: none!important;">
                                                    <h2 class="h2-panel-heading"> POS SYSTEM</h2>
                                                    <hr>
                                                    <div class="row">
                                                        <div class="col-sm-4">
                                    ...
                                    <div class="row">
                                        <div class="col-sm-7">
                                            ...
                                            <h4>
                                                <strong>AMOUNT DUE:
                                                    <hr class="summary">
                                                </strong><input type="text" name="" id="summary_amount_due" class="form-control numeric form-control-button" readonly="" style="font-size: 25px;color: red;">
                                            </h4>
                                            <h4>
                                                <strong> TENDERED:
                                                    <hr class="summary">
                                                </strong><input type="text" name="" id="summary_tendered" class="form-control numeric form-control-button" style="font-size: 25px;color: green;border:none;font-weight: normal;">
                                            </h4>
                                            <h4>
                                                <strong> CHANGE:
                                                    <hr class="summary">
                                                </strong><input type="text" name="" id="summary_change" class="form-control numeric form-control-button" readonly="" style="font-size: 25px;color: red;font-weight: bold;">
                                            </h4>
                                        </div>
                                        <div class="col-sm-5">
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="form-group" style="margin-bottom: 2px;">
                                                    <div class="input-group">
                                                        ...
                                                        <input type="text" name="modal_card_approval" class="form-control" data-error-msg="Parent is required." required>
                                                    </div>
                                                </div>
                                            </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            var keypressenter = $.Event("keypress", {
                which: 13
            });
            var itemcount = 0;
            var oTableItems = {
            ...
            var initializeControls = function() {
                ...
                _objTypeHead.typeahead(null, {
                    ...
                    if (splitQty > 0) {
                        ...
                        final_qty = tempQty;
                    } // IF QTY IS PRESENT, SET IT AS final_qty to be used below
                    ...
                    } //SCROLL TO BOTTOM WHEN SCROLLBAR IS PRESENT
                    tempQty = 0;
                    splitQty = 0; // SET Temporary QTY and Split QTY to zero
                });
            ...
            var bindEventHandlers = (function() {
                ...
                $('#btn_payment').click(function() {
                    ...
                    $('#summary_tendered').val(accounting.formatNumber(total, 2));
                    30.00
            ...
            var newRowItem = function(d) {
                if (d.is_bulk == '1') {
                    unit = d.child_unit_name;
                } else {
                    unit = d.parent_unit_name;
                }
                return '<tr>' +
            ...
            var checkDiscount = function() {
                ...
                if (final_percent > 100) {
                    showNotification({
                        title: "Error!",
                        stat: "error",
                        msg: 'Discount Percentage must not exceed to 100 !'
                    });
