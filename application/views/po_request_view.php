    ...
    <div id="wrapper">
        ...
        <a data-toggle="collapse" data-parent="#accordionA" href="#collapseTwo"><div class="panel-heading" style="background: #2ecc71;border-bottom: 1px solid lightgrey;"><b style="color: white; font-size: 12pt;"><i class="fa fa-bars"></i> Purchase Request</b></div></a> -->
                                                ...
                                                <div class="panel-body table-responsive">
                                                    <h2 class="h2-panel-heading">Purchase Requests
                                                        <!-- <small> | <a href="assets/manual/purchasing/Purchase_Order.pdf" target="_blank" style="color:#999999;"><i class="fa fa-question-circle"></i></a></small> -->
                                                    </h2>
                                                    <hr>
                                                ...
                                                <div class="panel-body">
                                                    ...
                                                    <div class="row" style="padding: 1%;margin-top: 0%;font-family: " Source Sans Pro", "Segoe UI" , "Droid Sans" , Tahoma, Arial, sans-serif">
                                                        <form id="frm_purchase_requests" role="form" class="form-horizontal">
                                                            <h2 class="h2-panel-heading">PR # : <span id="span_po_no">PR-XXXX</span></h2>
                                                            <hr>
                                                            <div>
                                                                <div class="row">
                                                                    <div class="col-sm-5">
                                                                ...
                                                                <table id="tbl_items" class="table table-striped" cellspacing="0" width="100%" style="font-font:tahoma;">
                                                                    ...
                                                                    <tfoot>
                                                                        ...
                                                                        <tr class="">
                                                                            ...
                                                                            <td id="td_total_after_discount" style="text-align: right;display: none;"><strong>0.00</strong></td>
...
<div id=" modal_confirmation" class="modal fade" tabindex="-1" role="dialog">
                                                        ...
                                                        <div id="modal_new_supplier" class="modal fade" tabindex="-1" role="dialog">
                                                            <!--modal-->
                                                ...
                                                $(document).ready(function() {
                                                        ...
                                                        $('#tbl_purchase_request tbody').on('click', 'button[name="edit_info"]', function() {
                                                            ...
                                                            if (getFloat(data.order_status_id) > 1) {
                                                                showNotification({
                                                                    "title": "Error!",
                                                                    "stat": "error",
                                                                    "msg": "Sorry, you cannot edit purchase request that is already been received."
                                                                });
                                                                return;
                                                            }
                                                            getproduct().done(function(data) {
                                                        ...
                                                        $('#tbl_purchase_request tbody').on('click', 'button[name="remove_info"]', function() {
                                                            ...
                                                            if (data.order_status_id != '1') {
                                                                showNotification({
                                                                    title: "Invalid",
                                                                    stat: "error",
                                                                    msg: "Only Open Purchase Request can be Deleted."
                                                                });
                                                            } else {
                                                                _selectedID = data.purchase_request_id;
                                                    ...
                                                    var createPurchaseRequest = function() {
                                                        ...
                                                        _data.push({
                                                            ...
                                                            value: tbl_summary.find(oTableDetails.tax_amount).text()
                                                        });
                                                        _data.push({
                                                    ...
                                                    var MarkRecordAsClosed = function() {
                                                        return $.ajax({
                                                            ...
                                                            "data": {
                                                                purchase_request_id: _selectedID
                                                            }
                                                        });
                                                    };
