            ...
            <div class="static-content"  >
                ...
                <div class="page-content"><!-- #page-content -->
                    ...
                    <ol class="breadcrumb" style="margin-bottom: 0px;">
                        ...
                        <li><a href="AdminInventory">Admin Inventory Report</a></li>
                    </ol>
                                            ...
                                            <div class="panel panel-default" style="border-radius: 0px;">
                                               <!--  <a data-toggle="collapse" data-parent="#accordionA" href="#collapseTwo"><div class="panel-heading" style="background: #2ecc71;border-bottom: 1px solid lightgrey;;"><b style="color:white;font-size: 12pt;><i class="fa fa-bars"></i> Inventory Report</b></div></a> -->
                                                <div id="collapseTwo" class="collapse in">
                                                    ...
                                                    <h2 class="h2-panel-heading">Admin Inventory Report</h2><hr>
                                                        ...
                                                        <div >
                                                            <table id="tbl_inventory" class="table table-striped" cellspacing="0" width="100%">
                                                                ...
                                                                <tfoot>
                                                                    ...
                                                                    <tr>
                                                                        <td colspan="8" style="text-align: right!important;"><b>Current Page Total : </b></td> 
                                                                        <td id="td_page_total" align="right"></td>
                                                                    </tr>
                                                                    <tr>
                                                                        <td colspan="8" style="text-align: right!important;"><b>Grand Total : </b></td> 
    ...
    $(document).ready(function(){
        ...
        var bindEventControls=function(){
            ...
            $(document).on('click','#btn_print_detailed',function(){
                window.open('AdminInventory/transaction/preview-inventory-with-total?depid='+$('#cbo_department').val()+'&date='+$('#txt_date').val()+'&ccf='+$('#cbo_current_count').val());
            });
            
            $(document).on('click','#btn_export_detailed',function(){
                window.open('AdminInventory/transaction/export-inventory-with-total?depid='+$('#cbo_department').val()+'&date='+$('#txt_date').val()+'&ccf='+$('#cbo_current_count').val());
            });

            $(document).on('click','#btn_export',function(){
                window.open('AdminInventory/transaction/export-inventory?depid='+$('#cbo_department').val()+'&date='+$('#txt_date').val()+'&ccf='+$('#cbo_current_count').val());
            });
            ...
            $(document).on('click','#btn_email',function(){
                ...
                $.ajax({
                    "dataType":"json",
                    "type":"POST",
                    "url":'AdminInventory/transaction/email-inventory?depid='+$('#cbo_department').val()+'&date='+$('#txt_date').val()+'&ccf='+$('#cbo_current_count').val(),
        ...
        function reloadList(){
            ...
            dt=$('#tbl_inventory').DataTable({
                ...
                "aaSorting": [],                
                "ajax": {
                    "url": "AdminInventory/transaction/get-inventory",
                    "type": "POST",
                    "bDestroy": true,
                    "data": function ( d ) {
                        return $.extend( {}, d, {
