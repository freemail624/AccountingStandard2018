            ...
            <div class="static-content"  >
                <div class="page-content"><!-- #page-content -->
                    ...
                    <ol class="breadcrumb" style="margin:0;">
                        ...
                        <li><a href="Item_units">Item Units</a></li>
                    </ol>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div id="div_unit_list">
                                        <div class="panel panel-default">
                                            ...
                                            <h2 class="h2-panel-heading"> Item Units</h2><hr>
                                            <div class="row-panel">                                                
...
$(document).ready(function(){
    ...
    var initializeControls=function(){
        dt=$('#tbl_units').DataTable({
            "dom": '<"toolbar">frtip',
            "bLengthChange":false,
            "ajax" : "Item_units/transaction/list",
            "language": {
                "searchPlaceholder":"Search Unit"
            },
            "columns": [
                { targets:[0],data: "item_unit_name" },
                { targets:[1],data: "item_unit_desc" },
                {
                    targets:[2],
        ...
        var createToolBarButton=function(){
            var _btnNew='<button class="btn btn-primary"  id="btn_new" style="text-transform: capitalize;font-family: Tahoma, Georgia, Serif;" data-toggle="modal" data-target="" data-placement="left" title="New Item unit" >'+
                '<i class="fa fa-plus"></i> New Item Unit</button>';
    ...
    var updateUnit=function(){
        ...
        return $.ajax({
            "dataType":"json",
            "type":"POST",
            "url":"Item_units/transaction/update",
            "data":_data,
            "beforeSend": showSpinningProgress($('#btn_save'))
        });
    };
    ...
    var removeUnit=function(){
        return $.ajax({
            "dataType":"json",
            "type":"POST",
            "url":"Item_units/transaction/delete",
