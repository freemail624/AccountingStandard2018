                                    ...
                                    <div id="div_adjustment_list">
                                        ...
                                        <div class="panel panel-default" style="border-top: 3px solid #2196f3;">
                                            <a data-toggle="collapse" data-parent="#accordionA" href="#collapseTwo">
                                                <div class="panel-heading" style="background: #2ecc71;border-bottom: 1px solid lightgrey;"><b style="color: white; font-size: 12pt;"><i class="fa fa-bars"></i> Adjustment (Out)</b></div>
                                            </a>
                                                                    ...
                                                                    <form id="frm_department_new">
                                                                        ...
                                                                        <div class="form-group">
                                                                            ...
                                                                            <div class="input-group">
                                                                                ...
                                                                                <input type="text" name="department_name" class="form-control" placeholder="Branch" data-error-msg="Parent name is required." required>
                                                                            </div>
                                                                        </div>
