            ...
            <div class="static-content"  >
                <div class="page-content"><!-- #page-content -->
                    <ol class="breadcrumb" style="margin:0%;">
                        ...
                        <li><a href="Income_statement">Income Statement (Department Costing)</a></li>
                    </ol>
                                ...
                                <div class="modal-dialog modal-md">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h4 class="modal-title" style="color: white;">Income Statement (Department Costing)</h4>
                                        </div>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('#btn_export').click(function(){
            window.open('Income_statement_field/transaction/export-excel?start='+$('#dt_start_date').val()+'&end='+$('#dt_end_date').val()+'&depid='+$('#cbo_departments').val());
        });
        ...
        $.ajax({
            "dataType":"json",
            "type":"POST",
            "url":"Income_statement_field/transaction/email-excel?start="+$('#dt_start_date').val()+'&end='+$('#dt_end_date').val()+'&depid='+$('#cbo_departments').val(),
