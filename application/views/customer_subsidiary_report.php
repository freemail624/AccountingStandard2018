...
<body>
    ...
    <hr>
    <div class="">
        <h3 class="report-header"><strong>BRANCH SUBSIDIARY REPORT</strong></h3>
    </div>
    <table width="100%" border="1" cellspacing="-1">
        <tr>
            <td style="padding: 4px;" width="50%"><strong>Branch: </strong><?php echo $subsidiary_info->customer_name; ?></td>
