...
<ol class="breadcrumb" style="margin-bottom: 0px;">
    ...
    <li><a href="Soa_settings">Fixed Asset Account Settings</a></li>
</ol>
...
<div class="row">
    <div class="col-md-12">
      ...
      <!--                   <h4><span style="margin-left: 1%"><strong><i class="fa fa-gear"></i> Accounts Receivable Accounts </strong></span></h4> -->
                    ...
                    <div class="col-sm-6">
                        <button id="btn_save_asset_settings" type="button" class="btn btn-primary" style="font-family: tahoma;text-transform: none;padding: 5px 10px!important"><span class=""></span> Save Account Changes</button>
                    </div>
            </div>
...
$(document).ready(function(){
    ...
    var bindEventHandlers=(function(){
            $('#btn_save_asset_settings').click(function(){
                saveSettingsItemTransfer().done(function(response){
                    showNotification(response);
                }).always(function(){
                    showSpinningProgress($('#btn_save_asset_settings'));
                });
            });
    })();
    ...
    var saveSettingsItemTransfer=function(){
        ...
        return $.ajax({
            "dataType":"json",
            "type":"POST",
            "url":"Asset_settings/transaction/save_accounts",
            "data":_data,
            "beforeSend": showSpinningProgress($('#btn_save_asset_settings'))
