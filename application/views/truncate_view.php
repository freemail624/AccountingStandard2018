...
<div class="tab-content">
    ...
    <div class="tab-pane" id="invoices" style="min-height: 300px;">
        ...
        <input type="checkbox" name="invoice[]" value="purchase_request_form" id="purchase_request_form" class="css-checkbox"><label class="css-label " for="purchase_request_form">Purchase Request (Form) Info </label>(<?php echo $current_count->purchase_request_form; ?>)<br>
        <input type="checkbox" name="invoice[]" value="purchase_request_form_items" id="purchase_request_form_items" class="css-checkbox"><label class="css-label " for="purchase_request_form_items">Purchase Request (Form) Items </label>(<?php echo $current_count->purchase_request_form_items; ?>)<br>
