                                        ...
                                        <div id="div_tax_list">
                                            <div class="panel panel-default">
                                                ...
                                                <div class="panel-body table-responsive">
                                                    <h2 class="h2-panel-heading"> Truncate Tables (Developers Only)</h2>
                                                    <hr>
                                                        ...
                                                        <div class="tab-content">
                                                            ...
                                                            <div class="tab-pane" id="references" style="min-height: 300px;">
                                                                ...
                                                                <form id="frm_references">
                                                                    ...
                                                                    <input type="checkbox" name="references[]" value="departments" id="departments" class="css-checkbox"><label class="css-label " for="departments">Parents</label>(<?php echo $current_count->departments ?>)<br>
                                                            ...
                                                            <div class="tab-pane" id="invoices" style="min-height: 300px;">
                                                                <form id="frm_invoices">
                                                                    ...
                                                                    <input type="checkbox" name="invoice[]" value="issuance_department_info" id="issuance_department_info" class="css-checkbox"><label class="css-label " for="issuance_department_info">Issuance Parent Info</label>(<?php echo $current_count->issuance_department_info; ?>)<br>
                                                                    <input type="checkbox" name="invoice[]" value="issuance_department_items" id="issuance_department_items" class="css-checkbox"><label class="css-label " for="issuance_department_items">Issuance Parent Items</label>(<?php echo $current_count->issuance_department_items; ?>)<br>
                                                            ...
                                                            <div class="tab-pane" id="masterfiles" style="min-height: 300px;">
                                                                ...
                                                                <form id="frm_masterfiles">
                                                                    ...
                                                                    <input type="checkbox" name="masterfiles[]" value="customers" id="customers" class="css-checkbox"><label class="css-label " for="customers">Branches</label>(<?php echo $current_count->customers; ?>)<br>
                                                                    <input type="checkbox" name="masterfiles[]" value="customer_photos" id="customer_photos" class="css-checkbox"><label class="css-label " for="customer_photos">Branches Photos</label>(<?php echo $current_count->customer_photos; ?>)<br>
