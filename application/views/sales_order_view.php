                                    ...
                                    <div id="div_user_list">
                                        <div class="panel panel-default" style="border: 4px solid #2980b9;">
                                            <div class="panel-body table-responsive">
                                                <h2 class="h2-panel-heading">Sales Order<small> | <a href="assets/manual/sales/Sales_Order.pdf" target="_blank" style="color:#999999;"><i class="fa fa-question-circle"></i></a></small></h2>
                                                <hr>
                                                                    ...
                                                                    <div class="row">
                                                                        <form id="frm_salesperson" role="form">
                                                                            <div class="">
                                                                                ...
                                                                                <div class="col-xs-12">
                                                                                    <div class="form-group">
                                                                                        <label class="col-xs-12 col-md-4 control-label "><strong><b>* </b> Parent :</strong></label>
                                                                                        <div class="col-xs-12 col-md-8">
                                                    ...
                                                    $('#tbl_sales_order tbody').on('click', 'button[name="edit_info"]', function() {
                                                        ...
                                                        if (getFloat(data.order_status_id) > 1) {
                                                            showNotification({
                                                                "title": "Error!",
                                                                "stat": "error",
                                                                "msg": "Sorry, you cannot edit sales order that is already been received."
                                                            });
                                                            return;
                                                        }
