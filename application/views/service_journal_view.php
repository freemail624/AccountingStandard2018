                    ...
                    <b style="color: white; font-size: 12pt;"><i class="fa fa-bars"></i>&nbsp; Review Service Journal (Pending)</b>
                                                    ...
                                                    <div id="" class="">
                                                        <div class="panel-body">
                                                            <h2 class="h2-panel-heading">Review Service Journal<small> | Pending <a href="assets/manual/services/Review_Service_Journal.pdf" target="_blank" style="color:#999999;"><i class="fa fa-question-circle"></i></a></small></h2>
                                                            <hr>
                                                            <div class="row-panel">
                ...
                <div class="panel-heading" style="background: #2ecc71;border-bottom: 1px solid lightgrey;">
                    <b style="font-size: 11pt;color:white;"><i class="fa fa-bars"></i> Services / AR Journal</b>
                                                    ...
                                                    <div class="panel-body" style="min-height: 400px;">
                                                        <h2 class="h2-panel-heading">Services / AR Journal<small> | <a href="assets/manual/services/Service_Ar_Journal.pdf" target="_blank" style="color:#999999;"><i class="fa fa-question-circle"></i></a></small></h2>
                                                        <hr>
                                                        <div class="row-panel">
                    ...
                    <div class="panel-ctrls" data-actions-container=""></div>
                                                        ...
                                                        <div class="panel-body">
                                                            <h2 class="h2-panel-heading"> Services Journal</h2>
                                                            <hr />
