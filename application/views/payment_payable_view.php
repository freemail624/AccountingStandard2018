...
<div data-widget-group=" group1">
            ...
            <b style="color: white; font-size: 12pt;"><i class="fa fa-bars"></i>&nbsp; Payment History</b>
                                            ...
                                            <div class="panel-body table-responsive" style="overflow-x: hidden;">
                                                <h2 class="h2-panel-heading">Payment History<small> | <a href="assets/manual/purchasing/Record_Payment.pdf" target="_blank" style="color:#999999;"><i class="fa fa-question-circle"></i></a></small></h2>
                                                <hr>
                                                <div class="row">
                                    ...
                                    <div id="div_payment_fields" style="display: none;">
                                        ...
                                        <div class="panel panel-default" style="border: 4px solid #2980b9;border-radius: 8px;">
                                            ...
                                            <div class="panel-body">
                                                <h2 class="h2-panel-heading">Add Payment</h2>
                                                <hr>
                                                <div>
