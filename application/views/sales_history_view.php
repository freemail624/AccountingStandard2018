            ...
            <b style="color: white; font-size: 12pt;"><i class="fa fa-bars"></i>&nbsp; Sales Invoice</b>
                                            ...
                                            <div class="panel-body table-responsive">
                                                <div class="row panel-row">
                                                    <h2 class="h2-panel-heading">Charge/Cash Invoice History</h2>
                                                    <hr>
                                                    <div class="row">
                                                        <div class="col-sm-4">
    ...
    <script>
        $(document).ready(function() {
            ...
            var initializeControls = function() {
                ...
                // $('#cbo_customers').append('<option value="0" selected="selected">ALL</option>');
            }();
            var bindEventHandlers = (function() {
                ...
                _cboCustomers.on("select2:unselecting", function(e) {
                    $('#cbo_customers').select2('val', 0)
                    $('#tbl_sales_invoice').DataTable().ajax.reload()
                });
            })();
