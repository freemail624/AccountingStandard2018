                                        ...
                                        <div id="div_category_list">
                                            <div class="panel panel-default">
                                                ...
                                                <div class="panel-body table-responsive">
                                                    <h2 class="h2-panel-heading">Salesperson<small> | <a href="assets/manual/masterfiles/Salesperson_Management.pdf" target="_blank" style="color:#999999;"><i class="fa fa-question-circle"></i></a></small></h2>
                                                    <hr>
                                ...
                                <div class="row">
                                    <form id="frm_salesperson" role="form">
                                        <div class="">
                                            <div class="col-xs-12">
                                                <div class="form-group">
                                                    <label class="col-xs-12 col-md-4 control-label "><strong>
                                                            <font color="red">*</font> Salesperson Code :
                                                        </strong></label>
                                            ...
                                            <div class="col-xs-12">
                                                <label class="col-xs-12 col-md-4 control-label "><strong>Parent :</strong></label>
                                                <div class="col-xs-12 col-md-8">
                                                    <select name="department_id" id="cbo_department" class="form-control" data-error-msg="Parent is required!" style="width: 100%;">
                                    ...
                                    <div class="row" style="margin: 1%;">
                                        <div class="col-lg-12">
                                            <div class="form-group" style="margin-bottom:0px;">
                                                <label class="">
                                                    <font color="red">*</font> Parent Name :
                                                </label>
