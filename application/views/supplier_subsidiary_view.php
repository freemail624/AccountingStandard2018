                                                ...
                                                <div class="panel panel-default">
                                                    ...
                                                    <div id="collapseTwo" class="collapse in">
                                                        <div class="panel-body">
                                                            <h2 class="h2-panel-heading">Supplier Subsidiary<small> | <a href="assets/manual/accountingreport/vendor/Supplier_Subsidiary.pdf" target="_blank" style="color:#999999;"><i class="fa fa-question-circle"></i></a></small></h2>
                                                            <hr>
                                                            <div>
                                                                <div class="row">
                                                                    <div class="col-lg-4">
            ...
            function reloadList() {
                ...
                dt = $('#tbl_supplier_subsidiary').DataTable({
                    ...
                    "ajax": {
                        ...
                        "data": function(d) {
                            return $.extend({}, d, {
                                "supplierId": _cboSuppliers.select2('val') ?? 0,
