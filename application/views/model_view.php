                                ...
                                <div class="row" style="margin: 1%;">
                                    <div class="col-lg-12">
                                        <div class="form-group" style="margin-bottom:0px;">
                                            ...
                                            <textarea name="model_name" class="form-control" data-error-msg="Model is required!" placeholder="Model Name" required></textarea>
...
$(document).ready(function(){
    ...
    var validateRequiredFields=function(){
        ...
        $('input[required],textarea[required]','#frm_models').each(function(){
            if($(this).val()==""){
    ...
    var createModel=function(){
        var _data=$('#frm_models').serializeArray();
    ...
    var clearFields=function(){
        $('input[required],textarea','#frm_models').val('');
