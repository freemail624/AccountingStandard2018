                        ...
                        <div class="container-fluid">
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <h2 class="h2-panel-heading">Statement of Account<small> | <a href="assets/manual/accountingreport/client/Statement_of_Account.pdf" target="_blank" style="color:#999999;"><i class="fa fa-question-circle"></i></a></small></h2>
                                    <hr>
                                    <div class="row">
                                        <div class="container-fluid">
                                    ...
                                    <div class="row">
                                        <div class="container-fluid">
                                            <table id="tbl_balances" width="100%" class="table table-bordered">
                                                <th class="th-label" colspan="5">
                                                    <h4 style="font-weight: bold;">PREVIOUS BALANCE</h4>
                                                </th>
                                                <tr>
                                                    <th>Invoice #</th>
                                                    <th>Date</th>
                                                ...
                                                <th colspan="5">
                                                    <h4 style="font-weight: bold;">CURRENT BALANCE</h4>
                                                </th>
                                                <tr>
                                                    <th>Invoice #</th>
                                                    <th>Date</th>
            ...
            function reinitializeBalances() {
                ...
                $.ajax({
                    ...
                    success: function(response) {
                        ...
                        if (prevbalsale == 0) {
                            $('#prevbalsale').addClass('hidden');
                        } else {
                            $('#prevbalsale').removeClass('hidden');
                        }
                        if (prevbalservice == 0) {
                            $('#prevbalservice').addClass('hidden');
                        } else {
                            $('#prevbalservice').removeClass('hidden');
                        }
                        ...
                        if (curbalsale == 0) {
                            $('#curbalsale').addClass('hidden');
                        } else {
                            $('#curbalsale').removeClass('hidden');
                        }
                        if (curbalservice == 0) {
                            $('#curbalservice').addClass('hidden');
                        } else {
                            $('#curbalservice').removeClass('hidden');
                        }
                        ...
                        if (paymentsale == 0) {
                            $('#paymentsale').addClass('hidden');
                        } else {
                            $('#paymentsale').removeClass('hidden');
                        }
                        if (paymentservices == 0) {
                            $('#paymentservices').addClass('hidden');
                        } else {
                            $('#paymentservices').removeClass('hidden');
                        }
