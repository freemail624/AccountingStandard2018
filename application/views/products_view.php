...
<!--                                             <div class="panel-heading">
                                            ...
                                            <h2 class="h2-panel-heading">Products<small> | <a href="assets/manual/masterfiles/Product_Management.pdf" target="_blank" style="color:#999999;"><i class="fa fa-question-circle"></i></a></small></h2><hr>
                                                ...
                                                <button id="btn_update_cost_upon_invoice" class="hidden">Update Cost Upon Invoice</button>
...
<!--                                                              <div class="form-group col-sm-4" style="margin-bottom:0px;">
                                                                ...
                                                                <div class="form-group" style="margin-bottom:0px;">
                                                                <br>
                                                                    <label  for="is_manual_price" style="text-align: left;vertical-align: middle;"><input type="checkbox" name="is_manual_price" class="" id="is_manual_price" style="transform: scale(2.0);">  &nbsp;&nbsp;Is Manual Price ?</label>
