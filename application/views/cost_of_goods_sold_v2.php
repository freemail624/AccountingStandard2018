                                         ...
                                         <div id="div_department_list">
                                             <div class="panel panel-default">
                                                 <div class="panel-body table-responsive">
                                                     <h2 class="h2-panel-heading">Cost of Goods Sold<small> | <a href="assets/manual/accountingreport/cost/Cost_of_Goods_Sold.pdf" target="_blank" style="color:#999999;"><i class="fa fa-question-circle"></i></a></small></h2>
                                                     <hr>
                                                     <div class="row">
                                                         <div class="col-lg-6">
                                                             Parent * : <br />
                                                         ...
                                                         <div class="col-sm-12">
                                                             <table style="width: 100%;border:none!important;">
                                                                 <tbody>
                                                                     <tr>
                                                                         <td style="width: 80%">
                                                                             <h4 style="font-weight: bold;">Merchandise Inventory - Beginning</h4><i> Beginning Inventory of Period <span class="period_start"></span> to <span class="period_end"></span></i>
                                                                         </td>
                                                         ...
                                                         <div class="col-sm-12">
                                                             <table style="width: 100%;border:none!important;">
                                                                 <tbody>
                                                                     <tr>
                                                                         <td style="width: 80%">
                                                                             <h4 style="font-weight: bold;"><small>Add:</small> Purchases</h4><i> Purchase Invoice of Period <span class="period_start"></span> to <span class="period_end"></span></i>
                                                                         </td>
                                                         ...
                                                         <div class="col-sm-12">
                                                                 ...
                                                                 <tbody>
                                                                     <tr>
                                                                         <td style="width: 80%;text-align:right;padding-right: 10px;">
                                                                             <h4 style="font-weight: bold;">Total Goods Available for Sale: </h4><i>( Merchandise Inventory [Beginning] + Purchases )</i>
                                                                         </td>
                                                             ...
                                                             <table style="width: 100%;border:none!important;">
                                                                 <tbody>
                                                                     <tr>
                                                                         <td style="width: 80%">
                                                                             <h4 style="font-weight: bold;"><small>Less:</small> Merchandise Inventory - End</h4><i> Inventory of Period <span class="period_start"></span> to <span class="period_end"></span></i>
                                                                         </td>
                                                             ...
                                                             <table style="width: 100%;border:none!important;">
                                                                 <tbody>
                                                                     <tr>
                                                                         <td style="width: 80%;text-align:right;padding-right: 10px;">
                                                                             <h4 style="font-weight: bold;">Cost of Goods Sold: </h4><i>Period <span class="period_start"></span> to <span class="period_end"></span></i>
                                                                         </td>
                 ...
                 function reloadPurchases() {
                     dtPurchases = $('#tbl_purchases').DataTable({
                         ...
                         "language": {
                             ...
                             "emptyTable": "No records found on specified parent and period"
                         },
                         "ajax": {
