    ...
    <div id="wrapper">
        ...
        <a data-toggle="collapse" data-parent="#accordionA" href="#collapseTwo"><div class="panel-heading" style="background: #2ecc71;border-bottom: 1px solid lightgrey;"><b style="color: white; font-size: 12pt;"><i class="fa fa-bars"></i> Purchase Order</b></div></a> -->
                                                ...
                                                <div class="panel-body table-responsive">
                                                    <h2 class="h2-panel-heading">Purchase Order<small> | <a href="assets/manual/purchasing/Purchase_Order.pdf" target="_blank" style="color:#999999;"><i class="fa fa-question-circle"></i></a></small></h2>
                                                    <hr>
                                                ...
                                                <div class="panel-body">
                                                    ...
                                                    <div class="row" style="padding: 1%;margin-top: 0%;font-family: " Source Sans Pro", "Segoe UI" , "Droid Sans" , Tahoma, Arial, sans-serif">
                                                        <form id="frm_purchases" role="form" class="form-horizontal">
                                                            <h2 class="h2-panel-heading">PO # : <span id="span_po_no">PO-XXXX</span></h2>
                                                            <hr>
                                                            <div>
                                                                <div class="row">
                                                                    <div class="col-sm-5">
...
<div id=" modal_confirmation" class="modal fade" tabindex="-1" role="dialog">
                                                        ...
                                                        <div id="modal_pr_list" class="modal fade" tabindex="-1" role="dialog">
                                                            <!--modal-->
                                                        ...
                                                        $('#tbl_purchases tbody').on('click', 'button[name="edit_info"]', function() {
                                                            ...
                                                            if (getFloat(data.order_status_id) > 1) {
                                                                showNotification({
                                                                    "title": "Error!",
                                                                    "stat": "error",
                                                                    "msg": "Sorry, you cannot edit purchase order that is already been received."
                                                                });
                                                                return;
                                                            }
                                                            getproduct().done(function(data) {
                                                        ...
                                                        $('#tbl_purchases tbody').on('click', 'button[name="remove_info"]', function() {
                                                            ...
                                                            if (data.order_status_id != '1') {
                                                                showNotification({
                                                                    title: "Invalid",
                                                                    stat: "error",
                                                                    msg: "Only Open Purchases can be Deleted."
                                                                });
                                                            } else {
                                                                _selectedID = data.purchase_order_id;
