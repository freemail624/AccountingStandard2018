                ...
                <table id="tbl_items" class="table table-striped" cellspacing="0" width="100%" style="font-font:tahoma;">
                    ...
                    <tr>
                        ...
                        <td align="right" colspan="1" id="" color="red">
                            ...
                            <input id="txt_overall_discount_amount" name="total_overall_discount_amount" type="hidden" class="numeric form-control" value="0.0000" />
                        </td>
    ...
    var bindEventHandlers=(function(){
        ...
        $('#tbl_items tbody').on('change','select',function(){
            if(changetxn == 'active'){
                ...
                $(oTableItems.unit_identifier,row).find('input').val(accounting.formatNumber(unit_value,4)); 
            } 
