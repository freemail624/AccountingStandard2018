    ...
    <div id="wrapper">
        <div id="layout-static">
            ...
            <div class="static-content-wrapper white-bg">
                                        ...
                                        <div id="div_pcf_list">
                                            <div class="panel panel-default">
                                                ...
                                                <div class="panel-body table-responsive">
                                                    <h2 class="h2-panel-heading"> Petty Cash Journal<small> | <a href="assets/manual/financing/Petty_Cash_Journal.pdf" target="_blank" style="color:#999999;"><i class="fa fa-question-circle"></i></a></small></h2>
                                                    <hr>
                                                    <div style="margin-bottom: 15px;">
                                                        ...
                                                        <div class="col-xs-12 col-md-3" style="margin-bottom: 10px;">
                                                            ...
                                                            <select id="cbo_department_filter" class="form-control" style="width: 100%;" data-error-msg="Parent is required" required>
                                            ...
                                            <div class="panel panel-default">
                                                ...
                                                <div class="panel-body">
                                                    <h2 class="h2-panel-heading">Petty Cash (Replenished)</h2>
                                                    <hr>
                ...
                <div id="modal_confirmation_replenishment" class="modal fade" role="dialog">
                    <!--modal-->
                ...
                <div id="modal_create_suppliers" class="modal fade" tabindex="-1" role="dialog">
                    <!--modal-->
                                    ...
                                    <div class="container-fluid">
                                        <form id="frm_petty_cash" role="form">
                                            <div class="col-xs-12 col-sm-6">
                                                ...
                                                <select id="cbo_department" class="form-control" name="department_id" style="width: 100%;" data-error-msg="Parent is required" required>
                                                    <option value="create_department">[Create New Parent]</option>
                                                    <?php foreach ($departments as $department) { ?>
                                                        <option value="<?php echo $department->department_id; ?>"><?php echo $department->department_name; ?></option>
                                                    <?php } ?>
                                                </select>
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header" style="background: #2ecc71">
                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">X</button>
                                <h2 id="department_title" class="modal-title" style="color:white;">New Parent</h2>
                            </div>
                            <div class="modal-body">
    ...
    <script>
        (function() {
                ...
                $('#btn_yes_replenishment').click(function() {
                    ...
                    if (account_title_credit == null) {
                        showNotification({
                            title: "Error!",
                            stat: "error",
                            msg: 'Account Title for Credit Entry is Required'
                        });
                    } else {
                ...
                $('#tbl_pcf > tbody').on('click', 'button[name="edit_info"]', function() {
                    ...
                    if (data.is_replenished == 1)
                        showNotification({
                            title: "Error!",
                            stat: "error",
                            msg: "Cannot edit this item, item already replenished."
                        });
                    else {
                        _selectedID = data.journal_id;
            ...
            var replenishPettyCash = function() {
                ...
                _data.push({
                    name: "aod",
                    value: _as_of_date.val()
                });
                _data.push({
                    name: "depid",
                    value: $('#cbo_department_filter').val()
                });
                _data.push({
                    name: "account_id_credit",
                    value: $('#cbo_account_title').val()
                });
