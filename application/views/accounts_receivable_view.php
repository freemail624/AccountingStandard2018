            ...
            <div class="static-content-wrapper white-bg">
                <div class="static-content">
                    ...
                    <b style="color: white; font-size: 12pt;"><i class="fa fa-bars"></i>&nbsp; Review Sales Journal (Pending)</b>
                                                                ...
                                                                <h2 class="h2-panel-heading">Review Sales Journal<small> | Pending <a href="assets/manual/financing/Review_Sales_Journal_Pending.pdf" target="_blank" style="color:#999999;"><i class="fa fa-question-circle"></i></a></small></h2>
                                                                <hr>
                                                            </a>
                                                            <div>
                    ...
                    <div class="panel-ctrls" data-actions-container=""></div>
                                                        ...
                                                        <div class="panel-body">
                                                            ...
                                                            <h2 class="h2-panel-heading">Sales Journal</h2>
                                                            <hr>
                                            ...
                                            $.ajax({
                                                ...
                                                "success": function(response) {
                                                    ...
                                                    if (response.stat == "success") {
                                                        $('#tbl_accounts_receivable').DataTable().ajax.reload()
                                                        $('#tbl_sales_review').DataTable().ajax.reload()
                                                    }
