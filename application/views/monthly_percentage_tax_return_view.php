...
<head>
    ...
    <style>
        ...
        #tbl_2551M td:nth-child(5),
        #tbl_2551M td:nth-child(6),
        #tbl_2551M td:nth-child(7) {
            text-align: right;
        }
    </style>
                                        ...
                                        <div id="div_2551M_form_list">
                                            <div class="panel panel-default">
                                                <div class="panel-body">
                                                    <h2 class="h2-panel-heading">Monthly Percentage Tax Return (BIR FORM #2551M)<small> | <a href="assets/manual/birforms/2551M.pdf" target="_blank" style="color:#999999;"><i class="fa fa-question-circle"></i></a></small></h2>
                                                    <hr>
                                                        ...
                                                        <div class="col-lg-3">
                                                            ...
                                                            <select class="form-control" name="year" id="year" width="100%">
                                                                ...
                                                                while ($minyear != $maxyear) { ?>
                                                                    <option value="<?php echo $minyear + 1; ?>" <?php if ($minyear + 1 == $active_year) {
                                                                                                                    echo 'selected';
                                                                                                                } ?>>
                                                                        <?php echo $minyear + 1; ?>
                                                                    </option>
                                        ...
                                        <div id="div_2551M_form_entry" class="hidden">
                                            <div class="panel panel-default">
                                                <div class="panel-body table-responsive">
                                                    <h2 class="h2-panel-heading">Generete BIR Form #2551M</h2>
                                                    <hr>
                                                    <form id="frm_2551m">
                                                        <div class="row" style="margin-bottom: 20px;">
                                                            <div class="col-lg-6">
                                                                        ...
                                                                        <div class="col-sm-6">
                                                                            ...
                                                                            <select class="form-control" name="month" id="month" width="100%">
                                                                                ...
                                                                                foreach ($months as $month) { ?>
                                                                                    <option value="<?php echo $month->month_id; ?>" <?php if ($month->month_id == $active_month) {
                                                                                                                                        echo 'selected';
    ...
    <script>
        $(document).ready(function() {
                ...
                $('input[required],textarea[required],select[required]').each(function() {
                    ...
                    if (_cstatus <= 0) {
                        showNotification({
                            title: "Error!",
                            stat: "error",
                            msg: "No Record Found for " + month + ' ' + year
                        });
                        stat = false;
                        return false;
                    } else {
            ...
            var get_monthly_tax_return = function() {
                ...
                _data.push({
                    name: "month",
                    value: _selMonth.select2('val')
                });
                _data.push({
                    name: "year",
                    value: _selYearEntry.select2('val')
                });
