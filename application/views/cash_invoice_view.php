                                    ...
                                    <td><button type="button" class="btn btn-default"><i class="fa fa-trash"></i></button></td>
                                                                ...
                                                                <tfoot>
                                                                    ...
                                                                    <tr class="">
                                                                        ...
                                                                        <td style="text-align: right;" colspan="6"><strong>Total before tax:</strong></td>
                                                                    ...
                                                                    <tr class="">
                                                                        <td colspan="8" style="text-align: right;"><strong><i class="glyph-icon icon-star"></i> Tendered :</strong></td>
                                                                        <td colspan="2" align="right" color="red">
                                                                            <input id="td_tendered" name="td_tendered" type="text" class="numeric form-control" value="0.00" />
                                                                        </td>
                                                                    </tr>
                                                                    <tr class="">
                                                                        <td colspan="8" style="text-align: right;"><strong><i class="glyph-icon icon-star"></i> Change :</strong></td>
                            ...
                            <form id="frm_customer_new">
                                <div class="row">
                                    <div class="col-md-8">
                                        ...
                                        <div class="col-md-12">
                                            <div class="col-md-4" id="label">
                                                <label class="control-label boldlabel" style="text-align:right;">Branch Type :</label>
                                            </div>
                                        ...
                                        <div class="col-md-12">
                                            <div class="col-md-4" id="label" style="padding-top: 10px;">
                                                <label class="control-label boldlabel" style="text-align:right;">Parent :</label>
                                            </div>
    ...
    <script>
        $(document).ready(function() {
                        ...
                        if ($(this).val() == "") {
                            ...
                            if (total_amount > total_tendered) {
                                showNotification({
                                    title: "Error!",
                                    stat: "error",
                                    msg: "Total Tendered amount must be equal or higher than Total Amount."
                                });
                                $("#td_tendered").focus();
                                $("#td_tendered").select();
                                stat = false;
            ...
            var createCashInvoice = function() {
                ...
                _data.push({
                    name: "total_tendered",
                    value: $('#td_tendered').val()
                });
                _data.push({
                    name: "total_change",
                    value: $('#td_change').text()
                });
