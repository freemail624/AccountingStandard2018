...
<div id="div_proforma_invoice_list">
    <div class="panel panel-default">
        ...
        <h2 class="h2-panel-heading">Pro Forma Invoice</h2><hr>
                ...
                <hr>
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4" >
                            ...
                            <input type="text" name="customer_name" class="form-control" required data-error-msg="Customer Name is required!" placeholder="Customer Name">
                        </div>
...
$(document).ready(function(){
    ...
    var initializeControls=function(){
        dt=$('#tbl_proforma_invoice').DataTable({
            ...
            "columns": [
                ...
                { targets:[1],data: "proforma_inv_no" },
    ...
    var updateProformaInvoice=function(){
        ...
        _data.push({name : "summary_tax_amount", value : tbl_summary.find(oTableDetails.inv_tax_amount).text()});
        _data.push({name : "summary_after_tax", value : tbl_summary.find(oTableDetails.after_tax).text()});
        _data.push({name : "proforma_invoice_id" ,value : _selectedID});
        return $.ajax({
            "dataType":"json",
            "type":"POST",
    ...
    var removeIssuanceRecord=function(){
        return $.ajax({
            ...
            "data":{proforma_invoice_id : _selectedID}
        });
    };
