                ...
                <div class="static-content">
                    <div class="page-content">
                        ...
                        <ol class="breadcrumb" style="margin-bottom: 0;">
                            ...
                            <li><a href="Proforma_invoice">Pro Forma Invoice</a></li>
                        </ol>
                        <div class="container-fluid"">
<div data-widget-group=" group1">
                            <div class="row">
                                <div class="col-md-12">
                                    <div id="div_proforma_invoice_list">
                                        <div class="panel panel-default">
                                            <div class="panel-body table-responsive">
                                                <div class="row panel-row">
                                                    <h2 class="h2-panel-heading">Pro Forma Invoice</h2>
                                                    <hr>
                                                    <table id="tbl_proforma_invoice" class="table table-striped" cellspacing="0" width="100%" style="">
                                                        <thead>
                                                            <tr>
                                                                <th></th>
                                                                <th>Invoice #</th>
                                    ...
                                    <div id="div_proforma_invoice_fields" style="display: none;">
                                        <div class="panel panel-default">
                                            <div class="pull-right">
                                                <h4 class="proforma_invoice_title" style="margin-top: 0%;"></h4>
                                            ...
                                            <div class="panel-body">
                                                <div class="row panel-row">
                                                    <form id="frm_proforma_invoice" role="form" class="form-horizontal">
                                                            ...
                                                            <div>
                                                                ...
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-sm-4">
                                                                        ...
                                                                        <input type="text" name="customer_name" class="form-control" required data-error-msg="Branch Name is required!" placeholder="Branch Name">
                                                                    </div>
                                                                ...
                                                                <div class="row">
                                                                    <div class="col-sm-8">
                                                                        <label>Deliver To Address :</label><br>
                                                        ...
                                                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12"><br />
                                                            ...
                                                            <div class="row" style="display: none;">
                                                                <div class="col-lg-4 col-lg-offset-8">
                                                                    <div class="table-responsive">
                                                                        <table id="tbl_proforma_invoice_summary" class="table invoice-total" style="font-family: tahoma;">
                                                                            <tbody>
                                                                                <tr>
                                                                                    <td>Discount :</td>
                                    ...
                                    <div class="col-md-8">
                                        <div class="col-md-12">
                                            <div class="col-md-4" id="label">
                                                <label class="control-label boldlabel" style="text-align:right;"><b>*</b> Branch Name :</label>
                                            </div>
    ...
    <script>
        $(document).ready(function() {
            ...
            var initializeControls = function() {
                dt = $('#tbl_proforma_invoice').DataTable({
                    "dom": '<"toolbar">frtip',
                    "bLengthChange": false,
                    "ajax": "Proforma_invoice/transaction/list",
                    "language": {
                ...
                var createToolBarButton = function() {
                    var _btnNew = '<button class="btn btn-success" id="btn_new" style="text-transform: none;font-family: Tahoma, Georgia, Serif; " data-toggle="modal" data-placement="left" title="Record Pro Forma Invoice" >' +
                        '<i class="fa fa-plus"></i> Record Pro Forma Invoice</button>';
            ...
            var bindEventHandlers = (function() {
                var detailRows = [];
                $('#tbl_proforma_invoice tbody').on('click', 'tr td.details-control', function() {
                    var tr = $(this).closest('tr');
                    var row = dt.row(tr);
                    var d = row.data();

                    window.open('Templates/layout/proforma-invoice/' + d.proforma_invoice_id + '?type=contentview');
                });
                ...
                $('#btn_new').click(function() {
                    _txnMode = "new";
                    clearFields($('#div_proforma_invoice_fields'));
                ...
                $('#tbl_proforma_invoice tbody').on('click', 'button[name="edit_info"]', function() {
                    _selectRowObj = $(this).closest('tr');
                    var data = dt.row(_selectRowObj).data();
                    _selectedID = data.proforma_invoice_id;
                    ...
                    if (_is_journal_posted > 0) {
                        ...
                        _txnMode = "edit";
                        $('.proforma_invoice_title').html('Edit Sales Invoice');
                        _selectRowObj = $(this).closest('tr');
                        var data = dt.row(_selectRowObj).data();
                        _selectedID = data.proforma_invoice_id;
                        ...
                        $.ajax({
                            url: 'Proforma_invoice/transaction/items/' + data.proforma_invoice_id,
                            type: "GET",
                            cache: false,
                            dataType: 'json',
                            processData: false,
                        ...
                        $('#span_invoice_no').html(data.proforma_inv_no);
                        $('#txt_overall_discount').val(accounting.formatNumber($('#txt_overall_discount').val(), 2));
                        showList(false);
                    }
                });
                $('#tbl_proforma_invoice tbody').on('click', 'button[name="remove_info"]', function() {
                    _selectRowObj = $(this).closest('tr');
                    var data = dt.row(_selectRowObj).data();
                    _selectedID = data.proforma_invoice_id;
                    _count = data.count;
                ...
                $('#btn_save').click(function() {
                    if (validateRequiredFields($('#frm_proforma_invoice'))) {
                        if (_txnMode == "new") {
                            CreateProformaInvoice().done(function(response) {
                                showNotification(response);
                                dt.row.add(response.row_added[0]).draw();
                                clearFields($('#frm_proforma_invoice'));
                                showList(true);
                            }).always(function() {
                                showSpinningProgress($('#btn_save'));
                            });
                        } else {
                            updateProformaInvoice().done(function(response) {
                                showNotification(response);
            ...
            var CreateProformaInvoice = function() {
                var _data = $('#frm_proforma_invoice,#frm_items').serializeArray();
                var tbl_summary = $('#tbl_proforma_invoice_summary');
                _data.push({
                    name: "remarks",
                ...
                return $.ajax({
                    "dataType": "json",
                    "type": "POST",
                    "url": "Proforma_invoice/transaction/create",
                    "data": _data,
                    "beforeSend": showSpinningProgress($('#btn_save'))
                });
            };
            var updateProformaInvoice = function() {
                var _data = $('#frm_proforma_invoice,#frm_items').serializeArray();
                var tbl_summary = $('#tbl_proforma_invoice_summary');
                _data.push({
                    name: "remarks",
                ...
                return $.ajax({
                    "dataType": "json",
                    "type": "POST",
                    "url": "Proforma_invoice/transaction/update",
                    "data": _data,
                    "beforeSend": showSpinningProgress($('#btn_save'))
                });
            };
            var removeIssuanceRecord = function() {
                return $.ajax({
                    "dataType": "json",
                    "type": "POST",
                    "url": "Proforma_invoice/transaction/delete",
                    "data": {
                        proforma_invoice_id: _selectedID
                    }
                });
            };
            var showList = function(b) {
                if (b) {
                    $('#div_proforma_invoice_list').show();
                    $('#div_proforma_invoice_fields').hide();
                    $('.datepicker.dropdown-menu').hide();
                } else {
                    $('#div_proforma_invoice_list').hide();
                    $('#div_proforma_invoice_fields').show();
                }
            };
