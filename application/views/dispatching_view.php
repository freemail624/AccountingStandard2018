                                        ...
                                        <div class="panel panel-default">
                                            <div class="panel-body table-responsive">
                                                <div class="row panel-row">
                                                    <h2 class="h2-panel-heading">Warehouse Dispatching<small> | <a href="assets/manual/sales/Warehouse_Dispatching.pdf" target="_blank" style="color:#999999;"><i class="fa fa-question-circle"></i></a></small></h2>
                                                    <hr>
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <div>
                                                    ...
                                                    <div id="custom-templates">
                                                        ...
                                                        <i class="pull-right">Note: Unit Price will depend on chosen Branch Type</i>
                                                    </div><br />
                                                    <form id="frm_items">
        ...
        $(document).ready(function() {
                        ...
                        },
                        {
                            ...
                            render: function(data, type, full, meta) {
                                ...
                                if (data.order_status == "Closed") {
                                    ...
                                    if (data.is_sales == 1) {
                                        return '<center>' + btn_accept_si + '</center>';
                                    } else {
                                        return '<center>' + btn_accept_ci + '</center>';
                                    }
                                }
            ...
            var removeDispatching = function() {
                return $.ajax({
                    ...
                    "data": {
                        dispatching_invoice_id: _selectedID
                    }
                });
            };
