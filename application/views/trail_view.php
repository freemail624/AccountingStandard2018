...
<!--                                             <div class="panel-heading">
                                            ...
                                            <h2 class="h2-panel-heading">Audit Trail<small> | <a href="assets/manual/settings/Audit_Trail.pdf" target="_blank" style="color:#999999;"><i class="fa fa-question-circle"></i></a></small></h2><hr>
                                                <div class="row">
                                                <div class="col-sm-3" >
                                                    Transaction Type :
