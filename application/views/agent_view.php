                                        ...
                                        <div id="div_category_list">
                                            <div class="panel panel-default">
                                                ...
                                                <div class="panel-body table-responsive">
                                                    <h2 class="h2-panel-heading">Agent<small>
                                                            <!--| <a href="assets/manual/masterfiles/Salesperson_Management.pdf" target="_blank" style="color:#999999;"><i class="fa fa-question-circle"></i></a> -->
                                                        </small></h2>
                                                    <hr>
                                            ...
                                            <div class="col-xs-12">
                                                <div class="form-group">
                                                    <label class="col-xs-12 col-md-4 control-label "><strong>
                                                            <font color="red">*</font> Agent Code :
                                                        </strong></label>
