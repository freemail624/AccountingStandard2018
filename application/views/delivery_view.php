            ...
            <b style="color: white; font-size: 12pt;"><i class="fa fa-bars"></i>&nbsp; Purchase Invoice</b>
                                            ...
                                            <div class="panel-body table-responsive">
                                                <div class="row panel-row">
                                                    <h2 style="margin-bottom: 0;" class="h2-panel-heading"> Purchase Invoice<small> | <a href="assets/manual/purchasing/Purchase_Invoice.pdf" target="_blank" style="color:#999999;"><i class="fa fa-question-circle"></i></a></small></h2>
                                                    <hr>
                                                                        ...
                                                                        <div class="col-md-12">
                                                                            ...
                                                                            <select name="supplier" id="cbo_suppliers" data-error-msg="Supplier is required." required>
                                                                                ...
                                                                                <?php foreach ($suppliers as $supplier) { ?>
                                                                                    <option value="<?php echo $supplier->supplier_id; ?>" data-tax-type="<?php echo $supplier->tax_type_id; ?>" data-address="<?php echo $supplier->address; ?>" data-contact-person="<?php echo $supplier->contact_name; ?>">
...
<div id=" modal_confirmation" class="modal fade" tabindex="-1" role="dialog">
                                                    ...
                                                    <div id="modal_confirmation_finalize" class="modal fade" tabindex="-1" role="dialog">
                                                        <!--modal-->
                            ...
                            <div class="form-group" style="margin-bottom:0px;">
                                ...
                                <select name="default_cost" id="cbo_default_cost" class="form-control" data-error-msg="Item type is required." required>
                                    ...
                                    <option value="2">Purchase Cost 2 (Viz-Min Area)</option>
                                                    ...
                                                    <div id="modal_new_term" class="modal fade" tabindex="-1" role="dialog">
                                                        <!--modal-->
                                                        <div class="modal-dialog modal-md">
                                                            <div class="modal-content">
                                                                <div class="modal-header">
                                                    ...
                                                    $('#tbl_delivery_invoice tbody').on('click', 'button[name="edit_info"]', function() {
                                                        ...
                                                        if (_is_journal_posted > 0) {
                                                            showNotification({
                                                                title: "Error!",
                                                                stat: "error",
                                                                msg: "Cannot Edit: Invoice is already Posted in Purchase Journal."
                                                            });
                                                        } else {
                                                            getproduct().done(function(data) {
                                                                products.clear();
                                                    ...
                                                    $('#tbl_delivery_invoice tbody').on('click', 'button[name="remove_info"]', function() {
                                                        ...
                                                        if (_is_journal_posted > 0) {
                                                            showNotification({
                                                                title: "Error!",
                                                                stat: "error",
                                                                msg: "Cannot Delete: Invoice is already Posted in Purchase Journal."
                                                            });
                                                        } else {
