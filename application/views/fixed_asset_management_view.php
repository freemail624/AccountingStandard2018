    ...
    <div id="wrapper">
        <div id="layout-static">
            ...
            <div class="static-content-wrapper white-bg">
                                        ...
                                        <div id="div_assets_list">
                                            <div class="panel panel-default">
                                                ...
                                                <div class="panel-body table-responsive">
                                                    <h2 class="h2-panel-heading">Fixed Asset Management<small> | <a href="assets/manual/fixedassetmanagement/Fixed_Asset_Management.pdf" target="_blank" style="color:#999999;"><i class="fa fa-question-circle"></i></a></small></h2>
                                                    <hr>
                ...
                <div id="modal_create_asset" class="modal fade" tabindex="-1" role="dialog">
                    <!--modal-->
                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header" style="background: #2ecc71">
                                <button type="button" class="close" data-dismiss="modal" aria-hidden="true">X</button>
                                <h2 id="department_title" class="" style="color:white;">New Parent</h2>
                            </div>
                            <div class="modal-body">
                                    ...
                                    <div class="row" style="margin: 1%;">
                                        <div class="col-lg-12">
                                            <div class="form-group" style="margin-bottom:0px;">
                                                ...
                                                <textarea name="department_name" id="department_txt" class="form-control" data-error-msg="Parent Name is required!" placeholder="Parent name" required></textarea>
                                    ...
                                    <div class="row" style="margin: 1%;">
                                        <div class="col-lg-12">
                                            <div class="form-group" style="margin-bottom:0px;">
                                                ...
                                                <textarea name="department_desc" id="department_txt_desc" class="form-control" placeholder="Parent Description"></textarea>
                        ...
                        $(document).ready(function() {
                            ...
                            function format(d) {
                                return '<table style="width: 80%;" id="fix_extend">' +
                                    ...
                                    '<td width="15%"><b>Parent :</b></td><td>' + d.department_name + '</td>' +
                                    '</tr>' +
                                    '</tbody>' +
                                    '</table>';
                            };
