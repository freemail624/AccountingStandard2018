...
<!--                 <div class="panel-heading">
                ...
                <div class="row">
                    <div class="col-lg-2"><br>
                        <button class="btn btn-primary"  id="btn_new" style="text-transform: capitalize;font-family: Tahoma, Georgia, Serif;" data-toggle="modal" data-target="" data-placement="left" title="New General Journal" ><i class="fa fa-plus"></i> New Journal</button>
                    </div>
                    <div class="col-lg-2">
                            From :<br />
...
$(document).ready(function(){
    ...
    var dtReview; var _cboDepartments; var _option; var _optGroup; var _selectedDepartment = 0;
            ...
            $('#tbl_billing_review tbody').on( 'click', 'tr td.details-control', function () {
                ...
                if ( row.child.isShown() ) {
                    ...
                    $.ajax({
                        ...
                        reInitializeDropDownAccounts(tbl,false);
                        reInitializeChildEntriesTableBilling(tbl);
    ...
    //              user defines
        ...
        var reInitializeChildEntriesTableBilling=function(tbl){
        ...
        var reInitializeChildElementsAdjustment=function(parent){
            ...
            parent.on('click','button[name="btn_finalize_journal_review"]',function(){
                ...
                if(isZero('#tbl_entries_for_review_adj'+_dataParentID)){
