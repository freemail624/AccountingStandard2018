...
<body class="animated-content" style="font-family: tahoma;">
    ...
    <div id="wrapper">
        <div id="layout-static">
                ...
                <div class="static-content">
                    ...
                    <b style="color: white; font-size: 12pt;"><i class="fa fa-bars"></i>&nbsp; General Journal </b>
                                                ...
                                                <div class="panel-body table-responsive" style="">
                                                    <h2 class="h2-panel-heading">Review General Journal <small>| Item Transfer <a href="assets/manual/financing/Review_General_Journal_Item_Transfer.pdf" target="_blank" style="color:#999999;"><i class="fa fa-question-circle"></i></a></small></h2>
                                                    <hr>
                                                    <div class="row-panel">
                                            ...
                                            <div class="panel panel-default">
                                                <div class="panel-body table-responsive">
                                                    <h2 class="h2-panel-heading">Review General Journal<small> | Adjustments <a href="assets/manual/financing/Review_General_Journal_Adjustments.pdf" target="_blank" style="color:#999999;"><i class="fa fa-question-circle"></i></a></small></h2>
                                                    <hr>
                                                    <div class="row-panel">
                    ...
                    <b style="color: white; font-size: 12pt;"><i class="fa fa-bars"></i>&nbsp; General Journal </b>
                                                ...
                                                <div class="panel-body table-responsive">
                                                    <h2 class="h2-panel-heading">General Journal<small> | <a href="assets/manual/financing/General_Journal.pdf" target="_blank" style="color:#999999;"><i class="fa fa-question-circle"></i></a></small></h2>
                                                    <hr>
                    ...
                    <h2>General Journal</h2>
                                                            ...
                                                            <h2 class="h2-panel-heading"> General Journal</h2>
                                                            <hr />
                                                            ...
                                                            <form id="frm_journal" role="form" class="form-horizontal">
                                                                <div>
                                                                    ...
                                                                    <label class="col-lg-2"> <b class="required">*</b> Parent :</label>
                                                                    <div class="col-lg-10">
                                                                        <select id="cbo_departments" name="department_id" class="selectpicker show-tick form-control" data-live-search="true" data-error-msg="Parent is required." required>
            ...
            <div id="modal_create_suppliers" class="modal fade" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false">
                <!--modal-->
            ...
            <div id="modal_create_customer" class="modal fade" tabindex="-1" role="dialog" data-backdrop="static" data-keyboard="false">
                <!--modal-->
                <div class="modal-dialog modal-lg">
                    <div class="modal-content">
                        <div class="modal-header" style="background-color:#2ecc71;">
                            <button type="button" class="close" data-dismiss="modal" aria-hidden="true">X</button>
                            <h4 class="modal-title" style="color:#ecf0f1;"><span id="modal_mode"> </span>New Branch Information</h4>
                        </div>
                ...
                $(document).ready(function() {
                        ...
                        $('#tbl_entries').on('click', 'button.remove_account', function() {
                            ...
                            if (oRow.length > 1) {
                                ...
                                showNotification({
                                    "title": "Error!",
                                    "stat": "error",
                                    "msg": "Sorry, you cannot remove all rows."
                                });
                            }
                            reComputeTotals($('#tbl_entries'));
                        });
                    ...
                    var reInitializeChildElementsAdjustment = function(parent) {
                        ...
                        parent.on('click', 'button[name="btn_finalize_journal_review"]', function() {
                            ...
                            if (isBalance('#tbl_entries_for_review_adj' + _dataParentID)) {
                                ...
                                showNotification({
                                    title: "Not Balance!",
                                    stat: "error",
                                    msg: 'Please make sure Debit and Credit amount are equal.'
                                });
                                stat = false;
                            }
                        ...
                        parent.on('click', 'button[name="btn_close_journal_review"]', function() {
                            ...
                            if (parent.find('input[name="closing_reason"]').val() == '' || parent.find('input[name="closing_reason"]').val() == null) {
                                showNotification({
                                    title: "Error!",
                                    stat: "error",
                                    msg: 'Please state the reason for Closing.'
                                });
                        ...
                        var CloseInvoiceAdjustment = function() {
                            ...
                            _dataClose.push({
                                name: 'closing_reason',
                                value: parent.find('input[name="closing_reason"]').val()
                            });
                            return $.ajax({
                                "dataType": "json",
                                "type": "POST",
                    ...
                    var reInitializeChildElements = function(parent) {
                        ...
                        var CloseInvoiceIssuance = function() {
                            ...
                            _dataClose.push({
                                name: 'trn_type',
                                value: parent.find('input[name="trn_type"]').val()
                            });
                            return $.ajax({
                                "dataType": "json",
                                "type": "POST",
                    ...
                    var createCustomer = function() {
                        ...
                        _data.push({
                            name: "photo_path",
                            value: $('img[name="img_customer"]').attr('src')
                        });
                    ...
                    var createSupplier = function() {
                        ...
                        _data.push({
                            name: "photo_path",
                            value: $('img[name="img_supplier"]').attr('src')
                        });
                        return $.ajax({
                            "dataType": "json",
                            "type": "POST",
                    ...
                    var createTemplate = function() {
                        ...
                        _data.push({
                            name: 'template_code',
                            value: $("#cbo_particulars option:selected").text()
                        });
                        _data.push({
                            name: 'book_type',
                            value: 'GJE'
