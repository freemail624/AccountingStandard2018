    ...
    <div id="wrapper">
        <div id="layout-static">
                ...
                <div class="static-content">
                    <div class="page-content">
                        ...
                        <ol class="breadcrumb" style="margin-bottom: 0;">
                            ...
                            <li><a href="users">Users <?php //print_r($user_groups); 
                                                        ?></a></li>
                        </ol>
                                        ...
                                        <div id="div_user_list">
                                            <div class="panel panel-default">
                                                ...
                                                <div class="panel-body table-responsive">
                                                    <h2 class="h2-panel-heading">User Accounts<small> | <a href="assets/manual/settings/Create_User_Accounts.pdf" target="_blank" style="color:#999999;"><i class="fa fa-question-circle"></i></a></small></h2>
                                                    <hr>
            ...
            <div id=" modal_confirmation" class="modal fade" tabindex="-1" role="dialog">
                                                        ...
                                                        <!---modal-->
                                                        <div id="modal_department" class="modal fade" tabindex="-1" role="dialog">
                                                            <!--modal-->
                                            ...
                                            <script>
                                                $(document).ready(function() {
                                                    ...
                                                    var createUserAccount = function() {
                                                        ...
                                                        _data.push({
                                                            name: "department_id",
                                                            value: $('#cbo_departments').select2('val')
                                                        });
