        ...
        <div class="panel panel-default" style="border-radius:6px;">
            <div id="collapseOne" class="collapse in">
                ...
                <div class="row">
                    ...
                    <div >
                        <table id="tbl_collection_posting" class="table table-striped" cellspacing="0" width="100%">
                            <thead class="">
                            <tr>
                                <th></th>
                                <th>Transaction #</th>
            ...
            <h2 class="h2-panel-heading">Revolving Fund Journal</h2><hr />
                <div>
                    <form id="frm_journal" role="form" class="form-horizontal">
                        ...
                        <div class="row">
                            <div class="col-lg-6">
                                <b class="required">*</b> Suppliers :<br />
                                <select id="cbo_suppliers" name="supplier_id" class="selectpicker show-tick form-control" data-live-search="true" data-error-msg="Supplier is required." required>
...
$(document).ready(function(){
    ...
    var _cbo_paymentMethod; var _cbo_departments; var dt; var _cbo_banks; var _cbo_accounttype; 
    ...
    var initializeControls=function(){
        ...
        dt=$('#tbl_collection_posting').DataTable({
            ...
            processing : true,
            "ajax" : {
                "url" : "Collection_posting/transaction/list",
                "bDestroy": true,            
                "data": function ( d ) {
                        return $.extend( {}, d, {
    ...
    var bindEventHandlers=function(){
        ...
        $("#txt_start_date_ar").on("change", function () {        
            $('#tbl_collection_posting').DataTable().ajax.reload()
        });
        ...
        $('#tbl_collection_posting tbody').on( 'click', 'tr td.details-control', function () {
            ...
            if ( row.child.isShown() ) {
                ...
                $.ajax({
                    "dataType":"html",
                    "type":"POST",
                    "url":"Templates/layout/journal-spj-collection?id="+ d.journal_id,
                    "beforeSend" : function(){
        ...
        $('#tbl_collection_posting').on('click','button[name="cancel_info"]',function(){
        ...
        $('#btn_yes').click(function(){
            $.ajax({
                "dataType":"json",
                "type":"POST",
                "url":"Collection_posting/transaction/cancel",
        ...
        $('#tbl_collection_posting').on('click','button[name="edit_info"]',function(){
            _txnMode="edit";
            ...
            $.ajax({
                url: 'Collection_posting/transaction/get-entries?id=' + data.journal_id,
                type: "GET",
                cache: false,
                dataType: 'html',
                processData: false,
    ...
    var createJournal=function(){
        ...
        return $.ajax({
            "dataType":"json",
            "type":"POST",
            "url":"Collection_posting/transaction/create",
            "data":_data,
    ...
    var updateJournal=function(){
        ...
        return $.ajax({
            "dataType":"json",
            "type":"POST",
            "url":"Collection_posting/transaction/update?id="+_selectedID,
            "data":_data,
            "beforeSend": showSpinningProgress($('#btn_save'))
        });
    };
