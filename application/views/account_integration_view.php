                ...
                <div class="static-content">
                    <div class="page-content">
                        ...
                        <ol class="breadcrumb" style="margin-bottom: 0px;">
                            ...
                            <li><a href="Account_integration">Account Integration <?php //print_r($user_groups); 
                                                                                    ?></a></li>
                        </ol>
                        <div class="container-fluid">
                            ...
                            <b style="color: white; font-size: 12pt;"><i class="fa fa-bars"></i>&nbsp; Customers</b>
                                                ...
                                                <div class="panel-body table-responsive">
                                                    <h2 class="h2-panel-heading">General Configuration<small> | <a href="assets/manual/settings/General_Configuration.pdf" target="_blank" style="color:#999999;"><i class="fa fa-question-circle"></i></a></small></h2>
                                                    <hr>
                                                    <div class="container-fluid">
                                                        <div data-widget-group="group1">
                                                            <div class="row">
                                                                <div class="col-md-12">
                                                                    <div class="tab-container tab-top tab-primary">
                                                                        <ul class="nav nav-tabs">
                                                                            ...
                                                                            <li><a href="#accounts_integration_setting_customer" data-toggle="tab" style="font-family: tahoma;"> Branch</a></li>
                                                                        ...
                                                                        <div class="tab-content">
                                                                            ...
                                                                            <div class="tab-pane" id="accounts_integration_default_settings" style="min-height: 300px;">
                                                                                <form id="frm_account_default_integration" role="form" class="form-horizontal row-border">
                                                                                    ...
                                                                                    <div class="form-group">
                                                                                        <label class="col-md-3 control-label"> <b class="required"> * </b>Branch :</label>
                                                                                        <div class="col-md-7">
                                                                                            <select name="default_customer_id" class="cbo_accounts" data-error-msg="Default Branch is required." required>
                                                                                            ...
                                                                                            <span class="help-block m-b-none">Please Choose a default branch for cash invoice. </span>
                                                                                        </div>
                                                                                    </div>
                                                                            ...
                                                                            <div class="tab-pane" id="accounts_integration_setting_customer" style="min-height: 300px;">
                                                                                <form id="frm_account_integration_customer" role="form" class="form-horizontal row-border">
                                                                                    <h4><span style="margin-left: 1%"><strong><i class="fa fa-gear"></i> Branch Integration Account</strong></span></h4>
                                                                                    <div class="form-group">
                                                                                    ...
                                                                                    <div class="form-group">
                                                                                        <label class="col-md-3 control-label"> * Receivable from Branch :</label>
                                                                                        <div class="col-md-7">
                                                                                            ...
                                                                                            <span class="help-block m-b-none">Account that represents the amount of goods and services credited by branch.</span>
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="form-group">
                                                                                        <label class="col-md-3 control-label"> * Discount to Branch :</label>
                                                                                        <div class="col-md-7">
                                                                                    ...
                                                                                    <div class="form-group">
                                                                                        ...
                                                                                        <div class="col-md-7">
                                                                                            ...
                                                                                            <span class="help-block m-b-none">Please select the account where payment of branch will be posted.</span>
                                                                                        </div>
                                                                                    </div>
                                                                                    <div class="col-sm-offset-3">
                                                                                        <button id="btn_save_customer_accounts" type="button" class="btn btn-primary" style="font-family: tahoma;text-transform: none;"><span class=""></span> Save Branch Configuration Changes</button>
                                                                                    </div>
                                                                                </form>
                                                                            </div>
                                                                            <!-- CUSTOMER END -->
