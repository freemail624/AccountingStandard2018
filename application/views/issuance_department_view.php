                ...
                <div class="static-content">
                    <div class="page-content">
                        ...
                        <ol class="breadcrumb" style="margin-bottom: 10px;">
                            ...
                            <li><a href="Issuance_department">Issuance to Parent</a></li>
                        </ol>
...
<div data-widget-group=" group1">
            ...
            <b style="color: white; font-size: 12pt;"><i class="fa fa-bars"></i>&nbsp; Issuance</b>
                                            ...
                                            <div class="panel-body table-responsive">
                                                <h2 class="h2-panel-heading">Issuance to Parent<small> | <a href="assets/manual/inventory/Issuance_to_Department.pdf" target="_blank" style="color:#999999;"><i class="fa fa-question-circle"></i></a></small></h2>
                                                <hr>
    ...
    <div class="panel-ctrls" data-actions-container=""></div>
                                            ...
                                            <div class="panel-body">
                                                ...
                                                <h2 class="h2-panel-heading" id="item_issuance_title">Issuance</h2>
                                                <hr>
                                                <div class="row">
                                                    <div class="container-fluid">
                                                        ...
                                                        <form id="frm_issuances" role="form" class="form-horizontal">
                                                            <div>
                                                                <div class="row">
                                                                    ...
                                                                    <div class="col-lg-4">
                                                                        <b class="required">*</b> From Parent : <br />
                                                                        <select name="from_department_id" id="cbo_departments" data-default="<?php echo $accounts[0]->default_department_id; ?>" class="cbo_departments" data-error-msg="From Parent is required." required>
                                                                    ...
                                                                    <div class="col-xs-12 col-lg-4">
                                                                        <b class="required">*</b> To Parent : <br />
                                                                        <select name="to_department_id" id="cbo_departments_to" class="cbo_departments" data-error-msg="To Parent is required." required>
                                                                            <option value="0">[ Create New Parent ]</option>
                                                                            <?php foreach ($departments as $department) { ?>
                                                                                <option value="<?php echo $department->department_id; ?>" data-tax-type="<?php echo $department->department_id; ?>"><?php echo $department->department_name; ?></option>
                                                                            <?php } ?>
                                            ...
                                            $(document).ready(function() {
                                                ...
                                                var initializeControls = function() {
                                                    ...
                                                    _cboDepartments = $("#cbo_departments").select2({
                                                        placeholder: "Issue item from Parent.",
                                                        allowClear: true
                                                    });
                                                ...
                                                var createIssuance = function() {
                                                    ...
                                                    _data.push({
                                                        ...
                                                        value: tbl_summary.find(oTableDetails.issue_tax_amount).text()
                                                    });
                                                    _data.push({
                                                ...
                                                var removeIssuanceRecord = function() {
                                                    return $.ajax({
                                                        ...
                                                        "data": {
                                                            issuance_department_id: _selectedID
                                                        }
                                                    });
                                                };
