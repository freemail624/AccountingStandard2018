...
<head>
    ...
    <style>
        ...
        td.details-control,
        td.items-details-control {
            background: url('assets/img/Folder_Closed.png') no-repeat center center;
            cursor: pointer;
        }

        tr.details td.details-control,
        tr.items-details td.items-details-control {
                            ...
                            <div data-widget-group="group1">
                                <div class="row">
                                    ...
                                    <b style="color: white; font-size: 12pt;"><i class="fa fa-bars"></i>&nbsp; Accounts Payable (Pending)</b>
                                                                ...
                                                                <h2 class="h2-panel-responsive">Purchase Journal<small> | Pending <a href="assets/manual/financing/Purchase_Journal_Pending.pdf" target="_blank" style="color:#999999;"><i class="fa fa-question-circle"></i></a></small></h2>
                                                                <hr>
                                                            </a>
                                                            <div>
                                                ...
                                                <div class="col-lg-12">
                                                    ...
                                                    <div class="panel panel-default">
                                                        <div class="panel-body panel-responsive">
                                                            <h2 class="h2-panel-heading">Purchase Journal</h2>
                                                            <hr />
            ...
            <script>
                $(document).ready(function() {
                    ...
                    var save_fixed_asset = function(form, dr_invoice_item_id, row) {
                        ...
                        _data.push({
                            name: "dr_invoice_item_id",
                            value: dr_invoice_item_id
                        });
