    ...
    <div class="row">
        <div class="col-lg-10 col-lg-offset-1">
            ...
            <div id="div_area_scale" style="position: relative;padding: 0%;">
                ...
                <div id="span_amount_words" data-description="Amount in Words"  class="drag_member" style="position: absolute;left: <?php echo $layouts->words_pos_left; ?>px;top: <?php echo $layouts->words_pos_top; ?>px;font-style: <?php echo $layouts->words_is_italic; ?>;font-weight:<?php echo $layouts->words_is_bold; ?>;font-size: <?php echo $layouts->words_font_size; ?>;font-family: <?php echo $layouts->words_font_family; ?>">***Amount in words***</div>

                <div id="span_date" data-description="Check Date" class="drag_member" style="position: absolute;left: <?php echo $layouts->date_pos_left; ?>px;top: <?php echo $layouts->date_pos_top; ?>px;font-style: <?php echo $layouts->date_is_italic; ?>;font-weight:<?php echo $layouts->date_is_bold; ?>;font-size: <?php echo $layouts->date_font_size; ?>;font-family: <?php echo $layouts->date_font_family; ?>">Date</div>
