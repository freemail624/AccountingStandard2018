...
<ol class="breadcrumb"  style="margin-bottom: 10px;">
    ...
    <li><a href="Open_deliveries">Open Deliveries</a></li>
</ol>
...
<!--         <div class="panel-heading">
        ...
        <h2 class="h2-panel-heading">Open Deliveries</h2><hr>
            ...
            <table id="tbl_delivery_invoice" class="table table-striped" cellspacing="0" width="100%">
                ...
                <tfoot>
                    <tr>
                        ...
                        <td id="page_total_amount" align="right"></td>
                        <td id="page_total_paid" align="right"></td>
                        <td id="page_total_balance" align="right"></td>
                    </tr>
                    <tr>
                        <td align="right" colspan="4">Grand Total : </td>
                        <td id="grand_total_amount" align="right"></td>
                        <td id="grand_total_paid" align="right"></td>
                        <td id="grand_total_balance" align="right"></td>
                    </tr>
                </tfoot>
            </table>
        </div>
...
$(document).ready(function(){
    ...
    var initializeControls=function(){
        ...
        dt=$('#tbl_delivery_invoice').DataTable({
            ...
            "ajax" : "Open_deliveries/transaction/list",
            "columns": [
                {
                ...
                {
                    sClass: "right_align_items", targets:[4],
                    data: "total_dr_amount",
                ...
                { visible:false,targets:[7],data: "supplier_name" }
            ...
            var last=null;
                        ...
                        api.column(7, {page:'current'} ).data().each( function ( group, i ) {
                            if ( last !== group ) {
                                $(rows).eq( i ).before(
                                    '<tr class="group"><td colspan="8" style="background-color:orange;"><strong>'+'Supplier: <i>'+group+'</i></strong></td></tr>'
                                );
            ...
            "footerCallback": function(a,b,c){
                ...
                $('#page_total_amount').html('<b>'+accounting.formatNumber(page_total_amount,2)+'</b>');
                $('#page_total_paid').html('<b>'+accounting.formatNumber(page_total_paid,2)+'</b>');
                $('#page_total_balance').html('<b>'+accounting.formatNumber(page_total_balance,2)+'</b>');

                $('#grand_total_amount').html('<b>'+accounting.formatNumber(grand_total_amount,2)+'</b>');
                $('#grand_total_paid').html('<b>'+accounting.formatNumber(grand_total_paid,2)+'</b>');
                $('#grand_total_balance').html('<b>'+accounting.formatNumber(grand_total_balance,2)+'</b>'); 
            }                    
