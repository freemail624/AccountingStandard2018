                                                ...
                                                <div class="panel panel-default" style="border-radius:6px;">
                                                    ...
                                                    <div id="collapseTwo" class="collapse in">
                                                        <div class="panel-body">
                                                            <h2 class="h2-panel-heading">Review Collection<small> | Pending <a href="assets/manual/financing/Review_Collection_Pending.pdf" target="_blank" style="color:#999999;"><i class="fa fa-question-circle"></i></a></small></h2>
                                                            <hr>
                                                            <div>
                                                ...
                                                <div class="panel panel-default" style="border-radius:6px;">
                                                    <div id="collapseOne" class="collapse in">
                                                        <div class="panel-body" style="">
                                                            <h2 class="h2-panel-heading">Cash Invoice<small> | Pending <a href="assets/manual/financing/Cash_Invoice_Pending.pdf" target="_blank" style="color:#999999;"><i class="fa fa-question-circle"></i></a></small></h2>
                                                            <hr>
                                                            <div>
                                                ...
                                                <div class="panel panel-default" style="border-radius:6px;">
                                                    <div id="collapseOne" class="collapse in">
                                                        <div class="panel-body" style="min-height: 400px;">
                                                            <h2 class="h2-panel-heading">Cash Receipt Journal<small> | <a href="assets/manual/financing/Cash_Receipt_Journal.pdf" target="_blank" style="color:#999999;"><i class="fa fa-question-circle"></i></a></small></h2>
                                                            <hr>
                                            ...
                                            <div class="row">
                                                <div class="col-sm-12">
                                                    <div class="panel panel-default">
                                                        ...
                                                        <div class="panel-body" style="min-height: 400px;">
                                                            <h2 class="h2-panel-heading">Cash Receipt Journal</h2>
                                                            <hr />
                                                            <div>
        ...
        <table id="table_hidden" class="hidden">
                    ...
                    <script>
                        $(document).ready(function() {
                            ...
                            var _txnMode;
                            var dtReview;
                            var _cbo_paymentMethod;
                            var _cbo_departments;
                            var dt;
                            var _cbo_banks;
                            var _cbo_accounttype;
                                    ...
                                    $.ajax({
                                        ...
                                        "success": function(response) {
                                            ...
                                            if (response.stat == "success") {
                                                $('#tbl_accounts_receivable').DataTable().ajax.reload()
                                                $('#tbl_collection_for_review').DataTable().ajax.reload()
                                                $('#tbl_cash_invoice_for_review').DataTable().ajax.reload()
                                            }
