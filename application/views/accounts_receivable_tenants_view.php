            ...
            <div class="static-content"  >
                ...
                <div class="page-content"><!-- #page-content -->
                    ...
                    <ol class="breadcrumb" style="margin-bottom: 0px;">
                        ...
                        <li><a href="Accounts_receivable_tenants">Accounts Receivable Schedule - Tenants</a></li>
                    </ol>
                                                    ...
                                                    <h2 class="h2-panel-heading">Accounts Receivable - Tenants</h2><hr>
                                                        <div style="">
                                                            <div class="row">
                                                                ...
                                                                <button class="btn btn-green" id="btn_email" style="text-transform: none; font-family: Tahoma, Georgia, Serif; " data-toggle="modal" data-target="#salesInvoice" data-placement="left" title="Email" >
                                                                ...
                                                                <div class="col-lg-3">
                                                                    Search:<br><input type="text" class="form-control" id="searchbox">
                                                                </div>
...
<script>
    $(document).ready(function(){
        var _cboAccounts; var dt; var initializeHeaderTable;
        ...
        formatPreviousDate = function(date){
            ...
            if(date==""){
                ...
                date=moment(new_date).subtract(1, "days").format("MMMM DD, YYYY");
            }
            return date;
        }
        ...
        formatCurrentDate = function(date){
            ...
            if(date==""){
                ...
                date=moment(new_date).format("MMMM DD, YYYY");
            }
            return date;

        }

        initializeHeaderTable=function(){

            var as_of_date = $('.date-picker').val();

            $('.previous_month').html(formatPreviousDate(as_of_date));
            $('.current_month').html(formatCurrentDate(as_of_date));
        ...
        var initializeControls=function(){
            ...
            dt=$('#tbl_accounts_receivable').DataTable({
                ...
                "bPaginate":false,
                "ajax": {
                    "url": "Accounts_receivable_tenants/transaction/ar-tenants-list",
                    "type": "POST",
                    "bDestroy": true,
                    "data": function ( d ) {
                        return $.extend( {}, d, {
