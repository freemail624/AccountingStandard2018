                                                ...
                                                <div class="panel panel-default" style="border-radius: 6px;border: 1px solid lightgrey;">
                                                    ...
                                                    <div id="collapseTwo" class="collapse in">
                                                        <div class="panel-body">
                                                            <h2 class="h2-panel-heading">Account Subsidiary<small> | <a href="assets/manual/accountingreport/otheraccountingreports/Account_Subsidiary.pdf" target="_blank" style="color:#999999;"><i class="fa fa-question-circle"></i></a></small></h2>
                                                            <hr>
                                                            <div>
                                                                <div class="row">
