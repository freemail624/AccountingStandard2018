...
<head>
    ...
    <style>
        ...
        #tbl_accounts_receivable td:nth-child(2),
        #tbl_accounts_receivable td:nth-child(3),
        #tbl_accounts_receivable td:nth-child(4),
        #tbl_accounts_receivable td:nth-child(5) {
            text-align: right;
        }
                                                ...
                                                <div class="panel panel-default" style="border-radius: 6px;">
                                                    ...
                                                    <div id="collapseTwo" class="collapse in">
                                                        <div class="panel-body">
                                                            <h2 class="h2-panel-heading">Accounts Receivable Entries<small> | <a href="assets/manual/accountingreport/client/Accounts_Receivable_Entries.pdf" target="_blank" style="color:#999999;"><i class="fa fa-question-circle"></i></a></small></h2>
                                                            <hr>
