                                        ...
                                        <div class="panel panel-default">
                                            <div class="panel-body table-responsive">
                                                <div class="row panel-row">
                                                    <h2 class="h2-panel-heading">Commercial Invoice</h2>
                                                    <hr>
                                                    ...
                                                    <form id="frm_commercial_invoice" role="form" class="form-horizontal">
                                                        <h2 class="h2-panel-heading">Invoice # : <span id="span_invoice_no">INV-XXXX</span></h4>
                                                            <div>
                                                                ...
                                                                <div class="col-sm-12">
                                                                    <div class="col-sm-4">
                                                                        <h2 class="h2-panel-heading">Bill to</h2>
                                                                        <hr>
                                                                        <div class="row">
                                                                            <div class="col-sm-12">
                                                                                <label>Branch :</label><br>
                                                                                <input class="form-control" id="" type="text" name="bill_customer" placeholder="" required data-error-msg="Bill to Branch is required!">
                                                                            </div>
                                                                            <div class="col-sm-12">
                                                                    ...
                                                                    <div class="col-sm-8">
                                                                        <div class="col-sm-12">
                                                                            <h2 class="h2-panel-heading">Ship to</h2>
                                                                            <hr>
                                                                            <div class="col-sm-6">
                                                                                <div class="col-sm-12">
                                                                                    <label>Branch :</label><br>
                                                                                    <input class="form-control" id="" type="text" name="ship_customer" placeholder="" required data-error-msg="Ship to Branch is required!">
                                                                                </div>
                                                                                <div class="col-sm-12">
                                                                                    <label>Address:</label><br>
        ...
        $(document).ready(function() {
            ...
            var removeIssuanceRecord = function() {
                return $.ajax({
                    ...
                    "data": {
                        commercial_invoice_id: _selectedID
                    }
                });
            };
