                                            ...
                                            <div class="tab-content">
                                                <div class="tab-pane active" id="accounts_integration_setting" style="min-height: 300px;">
                                                    <form id="frm_poleng_villa" role="form" class="form-horizontal row-border">
                                                        ...
                                                        <h5><span style="margin-left: 1%"><strong> Branch Account</strong></span></h5>
                                                        <div class="form-group">
                                                            <label class="col-md-2  col-md-offset-1 control-label"> * Branch:</label>
                                                            <div class="col-md-4 col-md-offset-0 col-md-offset-3">
                                                                <select name="customer_id" class="cbo_accounts" data-error-msg="Branch is required." required>
                ...
                <footer role="contentinfo">
                    <div class="clearfix">
                        <ul class="list-unstyled list-inline pull-left">
                            <li>
                                <h6 style="margin: 0;">&copy; 2017 - JDEV OFFICE SOLUTION INC</h6>
                            </li>
                        </ul>
