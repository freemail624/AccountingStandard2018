    ...
    <div id="wrapper">
        <div id="layout-static">
            ...
            <div class="static-content-wrapper white-bg">
                                        ...
                                        <div id="div_customer_list">
                                            <div class="panel panel-default">
                                                ...
                                                <div class="panel-body table-responsive">
                                                    <h2 class="h2-panel-heading">Branches
                                                        <!-- <small> | <a href="assets/manual/masterfiles/Customer_Management.pdf" target="_blank" style="color:#999999;"><i class="fa fa-question-circle"></i></a></small> -->
                                                    </h2>
                                                    <hr>
                ...
                <div id="modal_create_customer" class="modal fade" role="dialog">
                    <!--modal-->
