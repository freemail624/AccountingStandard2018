                                ...
                                <div class="modal-dialog modal-md">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h4 class="modal-title" style="color: white;">Comparative Income Statement</h4>
                                        </div>
                                                ...
                                                <div class="col-sm-12">
                                                    ...
                                                    <div class="input-group" style="z-index: 99999">
                                                        <span id="end_date_panel">
                                                            <input type="text" name="date_end" id="dt_end_date" class="date-picker form-control" value="<?php echo date("m/d/Y"); ?>"  placeholder="End Date" data-error-msg="End date is required!" required>
                                                        </span>
                                                        <span class="input-group-addon">
                                                             <i class="fa fa-calendar"></i>
                                                        </span>
...
<script type="text/javascript">
    $(document).ready(function(){
        var _cboDepartments; var _cboYears;
        ...
        var selected_year = _cboYears.select2('val');
            ...
            $('#start_date_panel').html("");
            $('#end_date_panel').html("");

            $('#start_date_panel').html('<input type="text" name="date_start" id="dt_start_date" class="date-picker form-control" placeholder="Start Date" data-error-msg="Start date is required!" value="01/01/'+selected_year+'" required>');
            $('#end_date_panel').html('<input type="text" name="date_end" id="dt_end_date" class="date-picker form-control" placeholder="End Date" data-error-msg="End date is required!" value="<?php echo date("m/d"); ?>/'+selected_year+'" required>');
        ...
        $('#btn_export').click(function(){
            window.open('Comparative_Income_statement/transaction/export-excel?start='+$('#dt_start_date').val()+'&end='+$('#dt_end_date').val()+"&depid="+_cboDepartments.select2('val'));
        });
    ...
    var showNotification=function(obj){
        ...
        $('#btn_print').click(function(){
         $(this).attr('href',"Templates/layout/comparative-income-statement?type=&type=preview&start="+$('#dt_start_date').val()+"&end="+$('#dt_end_date').val()+"&depid="+_cboDepartments.select2('val'));
