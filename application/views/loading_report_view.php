...
<div data-widget-group=" group1">
            ...
            <b style="color: white; font-size: 12pt;"><i class="fa fa-bars"></i>&nbsp; Sales Invoice</b>
                                            ...
                                            <div class="panel-body table-responsive">
                                                <div class="row panel-row">
                                                    <h2 class="h2-panel-heading">Loading Report</h2>
                                                    <hr>
                                                    <div class="row">
            ...
            <div id="modal_si_list" class="modal fade" tabindex="-1" role="dialog">
                <!--modal-->
        ...
        $(document).ready(function() {
            ...
            var bindEventHandlers = (function() {
                ...
                _cboAgentsTransfer.on('select2:select', function() {
                    ...
                    if (agent_id == transfer_id) {
                        showNotification({
                            title: "<b style='color:white;'> Error!</b> ",
                            stat: "error",
                            msg: "Truck must not be the same with the truck you will transfer."
                        });
                ...
                $('#btn_switch_invoice').on('click', function() {
                    ...
                    if (transfer_id == null) {
                        showNotification({
                            title: "<b style='color:white;'> Error!</b> ",
                            stat: "error",
                            msg: "Please select a truck to switch invoices."
                        });
                        return;
                    }
                ...
                $('#tbl_si_list > tbody').on('click', 'button[name="accept_si"]', function() {
                    ...
                    if (!(checkInvoice(data.sales_invoice_id))) { // Checks if item is already existing in the Table of Items for invoice
                        showNotification({
                            title: data.sales_inv_no,
                            stat: "error",
                            msg: "Invoice is Already Added."
                        });
                        return;
                    }
                    ...
                    $.ajax({
                        ...
                        if (row.total_posted > 0) {
                            showNotification({
                                title: "<b style='color:white;'> Error!</b> ",
                                stat: "error",
                                msg: "Cannot Delete: Invoices is already Posted in Sales Journal."
                            });
                        } else {
            ...
            var validateTableItems = function() {
                ...
                if (total_item_rows <= 0) {
                    showNotification({
                        title: "Error!",
                        stat: "error",
                        msg: "Please select atleast 1 invoice to proceed."
                    });
                    stat = false;
                    return false;
                }
            ...
            var createLoading = function() {
                ...
                _data.push({
                    ...
                    value: $('#td_grand_total_amount').text()
                });
                _data.push({
                    name: "grand_total_inv_qty",
                    value: $('#td_grand_total_inv_qty').text()
                });
                _data.push({
                    name: "is_switch",
                    value: is_switch
