...
<ol class="breadcrumb"  style="margin-bottom: 10px;">
    ...
    <li><a href="Open_purchase_request">Open Purchase Requests</a></li>
</ol>
...
<div id="div_delivery_list">
    <div class="panel panel-default">
       <!--  <div class="panel-heading">
        ...
        <h2 class="h2-panel-heading">Open Purchases Requests<!-- <small> | <a href="assets/manual/list/Open_Purchases_Report.pdf" target="_blank" style="color:#999999;"><i class="fa fa-question-circle"></i></a></small> --></h2><hr>
            ...
            <table id="tbl_purchase_requests" class="table table-striped" cellspacing="0" width="100%">
                <thead>
                <tr>
...
$(document).ready(function(){
    var dt; 
       ...
       var bindEventHandlers=function(){
        ...
        $('#btn_print').click(function(){
            window.open('Open_purchase_request/transaction/report');
        });

            $('#btn_export').on('click', function() {
                window.open('Open_purchase_request/transaction/export','_self');
            });
            ...
            $('#btn_email').on('click', function() {
                ...
                $.ajax({
                    "dataType":"json",
                    "type":"POST",
                    "url":'Open_purchase_request/transaction/email',
    ...
    var initializeControls=function(){
        ...
        dt=$('#tbl_purchase_requests').DataTable({
            "dom": '<"toolbar">frtip',
            "bLengthChange":false,
            "language": {
                "searchPlaceholder":"Search"
            },
            "ajax" : "Open_purchase_request/transaction/list",
            "columns": [
                {
                ...
                { targets:[3],data: "PrQtyTotal" },
                { targets:[4],data: "PrQtyDelivered" },
                { targets:[5],data: "PrQtyBalance" }
            ...
            var last=null;
                        ...
                        api.column(0, {page:'current'} ).data().each( function ( group, i ) {
                            if ( last !== group ) {
                                $(rows).eq( i ).before(
                                    '<tr class="group"><td colspan="7" style="background-color:orange;"><strong>'+'Purchase Request #: <i>'+group+'</i></strong></td></tr>'
                                );
