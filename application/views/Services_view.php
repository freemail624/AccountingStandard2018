    ...
    <div id="wrapper">
        <div id="layout-static">
            ...
            <div class="static-content-wrapper white-bg">
                                        ...
                                        <div id="div_service_list">
                                            <div class="panel panel-default">
                                                ...
                                                <div class="panel-body table-responsive">
                                                    <h2 class="h2-panel-heading"> Services<small> | <a href="assets/manual/services/Service_Management.pdf" target="_blank" style="color:#999999;"><i class="fa fa-question-circle"></i></a></small></h2>
                                                    <hr>
                                                    <div class="row-panel">
                ...
                <div id="modal_create_service" class="modal fade" role="dialog">
                    <!--modal-->
