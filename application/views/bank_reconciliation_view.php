                    ...
                    <div class="page-content">
                        ...
                        <div class="container-fluid">
                            <div class="panel panel-default">
                               ...
                               <b style="color: white; font-size: 12pt;"><i class="fa fa-bars"></i>&nbsp; Bank Reconciliation</b> 
                                ...
                                <div class="panel-body">
                                    <h2 class="h2-panel-heading">Bank Reconciliation<small> | <a href="assets/manual/bankreconciliation/Bank_Reconciliation.pdf" target="_blank" style="color:#999999;"><i class="fa fa-question-circle"></i></a></small></h2>
                                    <hr>
                                    <div class="row">
                                        <div class="container-fluid">
                                                        ...
                                                        <div class="row">
                                                            <div class="container-fluid">
                                                                <div class="container-fluid group-box">
                                                                    <span><strong><i class="fa fa-list"></i> ISSUED CHECKS</strong></span>
                                                                    <hr>
                                                            ...
                                                            <div class="container-fluid">
                                                                <div class="col-xs-12 col-sm-6">
                                                                    <div class="container-fluid group-box" style="padding: 15px 15px 0 15px;">
                                                                        <b><span class="fa fa-bars"></span> JOURNAL</b>
                                                                        <hr>
                                                                ...
                                                                <div class="col-xs-12 col-sm-6">
                                                                    <div class="container-fluid group-box" style="padding: 15px 15px 0 15px;">
                                                                        <b><span class="fa fa-bars"></span> BANK STATEMENT</b>
                                                                        <hr>
                                                                        ...
                                                                        <input type="text" class="form-control text-right numeric" name="actual_balance" value="0">
                                                                        <hr>
                                                                        <h5><b>DEDUCT :</b></h5>
                                                                        <div class="row">
                                                                            <div class="col-sm-8">
                            ...
                            <div class="panel panel-default">
                                ...
                                <div class="panel-body">
                                    <h2 class="h2-panel-heading">Reconciliation History<small> | <a href="assets/manual/bankreconciliation/Reconciliation_History.pdf" target="_blank" style="color:#999999;"><i class="fa fa-question-circle"></i></a></small></h2>
                                    <hr>
    ...
    <script>
        $(document).ready(function() {
            ...
            var reconcileChecks = function() {
                ...
                _data.push({
                    name: "account_id",
                    value: _cboAccounts.select2('val')
                });
                _data.push({
                    name: "account_balance",
                    value: $('input[name="account_balance"]').val()
                });
                _data.push({
                    name: "bank_service_charge",
                    value: $('input[name="bank_service_charge"]').val()
                });
                _data.push({
                    name: "nsf_check",
                    value: $('input[name="nsf_check"]').val()
                });
                _data.push({
                    name: "check_printing_charge",
                    value: $('input[name="check_printing_charge"]').val()
                });
                _data.push({
                    name: "interest_earned",
                    value: $('input[name="interest_earned"]').val()
                });
                _data.push({
                    name: "notes_receivable",
                    value: $('input[name="notes_receivable"]').val()
                });
                _data.push({
                    name: "adjusted_collected_balance_journal",
                    value: $('input[name="adjusted_collected_balance_journal"]').val()
                });
                _data.push({
                    name: "actual_balance",
                    value: $('input[name="actual_balance"]').val()
                });
                _data.push({
                    name: "outstanding_checks",
                    value: $('input[name="outstanding_checks"]').val()
                });
                _data.push({
                    name: "deposit_in_transit",
                    value: $('input[name="deposit_in_transit"]').val()
                });
                _data.push({
                    name: "adjusted_collected_balance_bank",
                    value: $('input[name="adjusted_collected_balance_bank"]').val()
                });
