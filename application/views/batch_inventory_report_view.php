                ...
                <div class="static-content">
                    ...
                    <div class="page-content">
                        ...
                        <ol class="breadcrumb" style="margin-bottom: 0px;">
                            ...
                            <li><a href="Batch_inventory">Batch Inventory Report</a></li>
                        </ol>
                                                    ...
                                                    <div id="collapseTwo" class="collapse in">
                                                        <div class="panel-body">
                                                            <h2 class="h2-panel-heading">
                                                                ...
                                                                <small class="hidden"> |
                                                                    <a href="assets/manual/inventory/Inventory_Report.pdf" target="_blank" style="color:#999999;"><i class="fa fa-question-circle"></i></a>
                                                                </small>
                                                            </h2>
                                                            <hr>
                                                            <div class="row">
                                                                <div class="col-lg-3">
                                                                    Product * : <br />
                                                                    <select id="cbo_product" class="form-control">
    ...
    <script>
        $(document).ready(function() {
            ...
            var initializeControls = function() {
                ...
                _cboProducts = $("#cbo_product").select2({
