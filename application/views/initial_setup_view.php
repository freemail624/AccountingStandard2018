    ...
    <div id="wrapper">
        <div id="layout-static">
            <div class="static-content-wrapper white-bg">
                                        ...
                                        <div id="div_company_fields">
                                            <div class="panel panel-default">
                                                ...
                                                <div class="panel-body">
                                                    <h2 class="h2-panel-heading">INITIAL SET-UP</h2>
                                                    <hr>
                                                        ...
                                                        <form id="frm_account_integration" role="form" class="form-horizontal row-border">
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <div class="col-lg-6">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label class="col-md-4 control-label"> <b style="color: red;">*</b> Receivable from Branch :</label>
                                                                        <div class="col-md-8">
                                                                    ...
                                                                    <div class="form-group">
                                                                        <label class="col-md-4 control-label"> <b style="color: red;">*</b> Discount to Branch :</label>
                                                                        <div class="col-md-8">
                                                                ...
                                                                <div class="col-lg-6">
                                                                    ...
                                                                    <div class="form-group">
                                                                        ...
                                                                        <div class="col-md-8">
                                                                            ...
                                                                            <span class="help-block m-b-none">Please select the account where payment of branch from Cash invoice will be posted..</span>
                                                                        </div>
                                                                    </div>
                                                                    <hr />
                ...
                <div id="modal_tax_group" class="modal fade" tabindex="-1" role="dialog">
                    <!--modal-->
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            var createCompanyInfo = function() {
                ...
                _data.push({
                    name: "photo_path",
                    value: $('img[name="img_company"]').attr('src')
                });
                _data.push({
                    name: "tax_type_id",
                    value: $('#tax_group').select2('val')
                });
                _data.push({
                    name: "business_type",
                    value: $('#business_type').select2('val')
                });
            ...
            var createUserAccount = function() {
                ...
                _data.push({
                    name: "user_group_id",
                    value: $('#cbo_user_groups').select2('val')
                });
