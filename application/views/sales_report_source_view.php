...
<div data-widget-group=" group1">
            ...
            <b style="color: white; font-size: 12pt;"><i class="fa fa-bars"></i>&nbsp; </b>
                                            ...
                                            <div class="panel-body table-responsive">
                                                ...
                                                <h2 class="h2-panel-heading">Sales Report By Source</h2>
                                                <hr>
                                                <div class="row">
                                                    <div class="col-sm-4">
                                                        <b>* </b> Order Source :<br />
                                ...
                                <footer role="contentinfo">
                                    <div class="clearfix">
                                        <ul class="list-unstyled list-inline pull-left">
                                            <li>
                                                <h6 style="margin: 0;">&copy; 2016 - JDEV OFFICE SOLUTIONS</h6>
                                            </li>
                                        </ul>
                    ...
                    <script>
                        $(document).ready(function() {
                            ...
                            function reinitializeBalances() {
                                ...
                                data.push({
                                    name: "oi",
                                    value: $('#cbo_order_source').val()
                                });
                                data.push({
                                    name: "si",
                                    value: $('#source_invoice').val()
                                });
                                data.push({
                                    name: "start",
                                    value: $('#txt_start_date').val()
                                });
                                data.push({
                                    name: "end",
                                    value: $('#txt_end_date').val()
                                });
                                $.ajax({
