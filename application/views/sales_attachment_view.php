                        ...
                        <div class="mail-box-header">
                            ...
                            <div class="row">
                                <div class="col-lg-12">
                                    ...
                                    Sales Invoice # :
                                    <h4>
                                        <strong><?php echo $info[0]->sales_inv_no; ?></strong>
                                    </h4>


                                    <div>
                                        <br /> Supplier :<br /> <strong><?php echo $info[0]->customer_name; ?></strong>
                                        <br /><br />  Remarks :<br /> <strong><?php echo $info[0]->remarks; ?></strong>
                            ...
                            <div class="">
                                <h5>
                                    <span class="pull-right font-normal">Created : <?php echo $info[0]->date_created; ?></span>
                                    <span class="font-normal">Posted by : <?php echo $info[0]->posted_by; ?></span>
                                </h5>
                            </div>
                            ...
                            <div class="mail-attachment">
                                <div class="pull-right">
                                    <a href="#" class="btn btn-white btn-sm btn_upload_file"" data-toggle="tooltip" data-placement="top" title="Add Attachments"><i class="fa fa-paperclip"></i> Add Attachments to Sales</a>

                                </div>

                                <p>
                                    <span><i class="fa fa-paperclip"></i> <span id="attach_count"><?php echo count($attachments); ?></span> attachment(s) - </span>
<!--                                     <a href="#">Download all</a>
                                ...
                                <div class="attachment_file">
                                    ...
                                    <div class="file-box"  data-id="<?php echo $file->sales_attachment_id; ?>">
                                        <div class="file">
                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane active" id="home1">
                                                ...
                                                <div class="feed-activity-list">
                                                    ...
                                                    <div class="feed-element" data-id="<?php echo $msg->sales_message_id; ?>">
                                                        ...
                                                        <div class="media-body">
                                                            ...
                                                            <div class="pull-right">
                                                                ...
                                                                <a id="btn_remove_announcement" data-id="<?php echo $msg->sales_message_id; ?>" class="btn btn-xs btn-white"><i class="fa fa-trash"></i> </a>
                                                                <?php } ?>
                                                            </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-12">
                                                        <input id="txt_sales_invoice_id" name="sales_invoice_id" type="hidden" value="<?php echo $info[0]->sales_invoice_id; ?>" />
    ...
    $(document).ready(function(){
            ...
            var bindEventHandlers=(function(){
                ...
                $('#btn_post_message').click(function(){
                    ...
                    if(msg!=""){
                        ...
                        showNotification({title: 'Warning',stat:"error",msg: "Message must not be empty!"});
                        return;
                    }
                });
                ...
                $('div.feed-activity-list').on('click','#btn_remove_announcement',function(){
                    ...
                    $.ajax({
                        "dataType":"json",
                        "type":"POST",
                        "url":"Sales_attachments/transaction/delete-message/"+id
                ...
                $('#btn_upload').click(function(){
                    ...
                    $.ajax({
                        url : 'Sales_attachments/transaction/upload-attachments?id='+$('#txt_sales_invoice_id').val(),
                        type : "POST",
                        data : data,
                        cache : false,
                        dataType : 'json',
            ...
            var messageRequest=function(){
                setInterval(function(){
                    ...
                    $.ajax({
                        "dataType": "json",
                        "type": "GET",
                        "url": "Sales_attachments/transaction/list-messages/"+$('#txt_sales_invoice_id').val(),
                        "success": function (response) {


                            //console.log(response);
                            var _parent=$('.feed-activity-list');
                            var _messages=response.sales_messages;

                            $.each(_messages,function(i,value){
                                var _target=_parent.find('.feed-element[data-id="'+value.sales_message_id+'"]');
                            ...
                            var _list=response.sales_attachments;


                            $.each(_list,function(i,value){
                                _attachCount++;
                                //alert(value.file_id);
                                var _fileTarget=_attachParent.find('.file-box[data-id="'+value.sales_attachment_id+'"]');
            ...
            var postMessage=function(){
                ...
                return $.ajax({
                    "dataType":"json",
                    "type":"POST",
                    "url":"Sales_attachments/transaction/post-message",
                    "data":data,
                    "beforeSend" : function(){
                        showSpinningProgress($('#btn_post_message'));
                    }
            ...
            var createMessageFeedStructure=function(row){
                var _btnTrash=(<?php echo $this->session->user_id; ?>==row.user_id?'<a id="btn_remove_announcement" data-id="'+row.sales_message_id+'" class="btn btn-xs btn-white"><i class="fa fa-trash"></i> </a>':'');

                return '<div class="feed-element" data-id="'+row.sales_message_id+'">'+
                '<a href="#" class="pull-left">'+
            ...
            var createAttachmentStructure=function(row){
                return '<div class="file-box"  data-id="'+row.sales_attachment_id+'">'+
                '<div class="file">'+
