...
<head>
    ...
    <style>
        ...
        #tbl_check_list td:nth-child(6),
        #tbl_check_list th:nth-child(6) {
            text-align: center;
        }
...
<body class="animated-content" style="font-family: tahoma;">
                                                ...
                                                <div class="panel panel-default">
                                                    <div class="panel-body panel-responsive">
                                                        <a data-toggle="collapse" data-parent="#accordionA" href="#collapseTwo" style="text-decoration: none;">
                                                            ...
                                                            <h2 class="h2-panel-heading"> Review Expense<small> | Pending <a href="assets/manual/financing/Review_Expense_Pending.pdf" target="_blank" style="color:#999999;"><i class="fa fa-question-circle"></i></a></small></h2>
                                                            <hr>
                                                        </a>
                                                ...
                                                <div class="panel panel-default" style="border-radius:6px;">
                                                    <div class="panel-body panel-responsive">
                                                        <a data-toggle="collapse" data-parent="#accordionA" href="#collapseOne" style="text-decoration: none;">
                                                            ...
                                                            <h2 class="h2-panel-heading">Cash Disbursement Journal<small> | <a href="assets/manual/financing/Cash_Disbursement_Journal.pdf" target="_blank" style="color:#999999;"><i class="fa fa-question-circle"></i></a></small></h2>
                                                            <hr>
                                                                            ...
                                                                            <div class="col-md-12">
                                                                                ...
                                                                                <div class="row">
                                                                                    <div class="col-sm-12">
                                                                                        ...
                                                                                        <select id="cbo_branch" name="department_id" class="selectpicker show-tick form-control" data-live-search="true" data-error-msg="Parent is required." required>
    ...
    <table id=" table_hidden" class="hidden">
                            ...
                            <footer role="contentinfo">
                                <div class="clearfix">
                                    <ul class="list-unstyled list-inline pull-left">
                                        <li>
                                            <h6 style="margin: 0;">&copy; 2018 - JDEV OFFICE SOLUTION INC</h6>
                                        </li>
                                    </ul>
                ...
                <div id="modal_print_check_list_option" class="modal fade" tabindex="-1" role="dialog">
                    <!--modal-->
                ...
                <div id="modal_check_layout" class="modal fade" tabindex="-1" role="dialog">
                    <!--modal-->
                    <div class="modal-dialog modal-md">
                        <div class="modal-content">
                            <div class="modal-header" style="background-color:#2ecc71;">
                ...
                <script>
                    $(document).ready(function() {
                        ...
                        var _selectRowObj;
                        var _selectedID;
                        var _txnMode, _cboBranches, _cboPaymentMethod, _cboBanks, _cboAccountType;
                        var dtReview;
                        var cbo_refType;
                        var _cboLayouts;
                        var dtRecurring;
                        ...
                        var bindEventHandlers = function() {
                            ...
                            $('#btn_preview_check').click(function() {
                                if ($('#cbo_layouts').select2('val') != null || $('#cbo_layouts').select2('val') != undefined)
                                    ...
                                    showNotification({
                                        title: 'Error',
                                        msg: 'Please select check layout!',
                                        stat: 'error'
                                    });
                            });
                        ...
                        var createTemplate = function() {
                            ...
                            _data.push({
                                name: 'template_code',
                                value: $("#cbo_suppliers option:selected").text()
                            });
                            _data.push({
                                name: 'book_type',
                                value: 'CDJ'
                        ...
                        var validateRequiredFields = function(f) {
                            ...
                            if (!isBalance()) {
                                showNotification({
                                    title: "Error!",
                                    stat: "error",
                                    msg: 'Please make sure Debit and Credit is balance.'
                                });
                                stat = false;
                            }
