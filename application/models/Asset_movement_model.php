...
class Asset_movement_model extends CORE_Model {
    ...
    function __construct() {
        parent::__construct();
         ...
         function get_list_with_location_count(){
                ...
                SELECT 
                DISTINCT(o.current_location_id) as current_location_id,
                l.location_name
                 FROM(
                SELECT
                fa.fixed_asset_id,
         ...
         function get_list_with_status($category_id=null){
                $this->db->query("SET @row_number = 0;");
                $this->db->query("SET @fixed_id = 0;");
                $sql="
                ...
                WHERE
                    main.num = 1) as am On am.fixed_asset_id = fa.fixed_asset_id 
                    WHERE fa.is_active = TRUE AND fa.is_deleted = FALSE
                    ".($category_id==null?"":" AND fa.category_id ='".$category_id."'")."
