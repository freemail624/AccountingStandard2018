...
class Truncate_model extends CORE_Model{
    ...
    function get_current_counts(){
        $sql="SELECT 
                ...
                (SELECT COUNT(*) FROM loading) as loading,
                (SELECT COUNT(*) FROM loading_items) as loading_items,
                (SELECT COUNT(*) FROM repair_order) as repair_order,
                (SELECT COUNT(*) FROM repair_order_items) as repair_order_items,
                ...
                (SELECT COUNT(*) FROM insurance) as insurance,
                (SELECT COUNT(*) FROM customer_vehicles) as customer_vehicles,
                ...
                (SELECT COUNT(*) FROM vehicle_model) as vehicle_model,
                (SELECT COUNT(*) FROM colors) as colors,
                (SELECT COUNT(*) FROM vehicle_year) as vehicle_year,
                (SELECT COUNT(*) FROM makes) as makes,
                (SELECT COUNT(*) FROM bins) as bins,
                (SELECT COUNT(*) FROM brands) as brands,
                (SELECT COUNT(*) FROM order_source) as order_source,
                ...
                (SELECT COUNT(*) FROM asset_movement) as asset_movement,
