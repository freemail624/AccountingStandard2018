...
class CORE_model extends CI_Model
{
    ...
    function get_list_v2($where_filter=null,$select_list=null,$join_array=null,$inner_join=null,$order_by=null,$group_by=null,$auto_select_escape=TRUE,$limit=null,$having=null){
        ...
        if($inner_join!=null){
            foreach($inner_join as $tbl_join){
                $this->db->join($tbl_join[0],$tbl_join[1]);
            }
        }
